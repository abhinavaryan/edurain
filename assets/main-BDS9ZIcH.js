const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/courses-BUfp9lGm.js","assets/courses-BKPhEzz0.js","assets/faq-Bo7AT8JC.js","assets/blogs-CyybONT9.js","assets/vendor-BpCc1Cic.js","assets/rolldown-runtime-QTnfLwEv.js","assets/vendor-DVB7LGv8.css","assets/categoryCourses-Ddtl866C.js","assets/blogAdmin-BqCXeWJR.js","assets/blogAdminLogin-Cblq4WmZ.js"])))=>i.map(i=>d[i]);
import"./modulepreload-polyfill-Dezn_h7o.js";import{Ct as e,Dt as t,Et as n,Ot as r,St as i,Tt as a,bt as o,dt as s,gt as c,lt as l,ut as u,vt as d,wt as f,xt as p,yt as m}from"./vendor-BpCc1Cic.js";var h=r({apiKey:`AIzaSyBLw5eneJGCi4-YshAf5wgBA-yDT8o70Mc`,authDomain:`edurain-pvt.firebaseapp.com`,projectId:`edurain-pvt`,storageBucket:`edurain-pvt.firebasestorage.app`,messagingSenderId:`5660601224`,appId:`1:5660601224:web:e12194bc33e38cd1e8e83d`,measurementId:`G-JL0D0KVQYZ`}),g=e(h),_=o(h);u(h);var v=async(e,t,n)=>{try{await c(m(_,`users`,e),{name:t,email:n,created_at:p()})}catch(e){throw Error(`Could not save user data: `+e.message)}},y=async(e,t,n)=>{try{await s(d(_,`contacts`),{name:e,email:t,message:n,created_at:p()})}catch(e){throw Error(`Could not send message: `+e.message)}},b=async(e,n,r)=>{try{let a=(await i(g,n,r)).user;return await t(a,{displayName:e}),await v(a.uid,e,n),a}catch(e){throw Error(e.message||`Registration failed`)}},x=async(e,t)=>{try{return(await a(g,e,t)).user}catch(e){throw Error(e.message||`Login failed`)}},S=async()=>{try{await n(g)}catch(e){throw Error(e.message||`Logout failed`)}},C=e=>f(g,e);function w(){return`
        <nav class="navbar" id="main-nav">
            <div class="navbar-container">
                <div class="logo">
                    <a href="https://www.edurain.in" style="text-decoration: none; display: flex; align-items: center; gap: 4px;">
                        <img src="/images/logo.webp" fetchpriority="high" alt="EduRain Logo" width="65" height="55" style="height: 55px; width: auto; max-width: 65px; object-fit: contain;">
    ...
    `}function D(){document.querySelectorAll(`.social-dropdown-toggle`).forEach(e=>{let t=e.closest(`.social-dropdown-wrapper`);t&&e.addEventListener(`click`,e=>{e.stopPropagation(),document.querySelectorAll(`.social-dropdown-wrapper.active`).forEach(e=>{e!==t&&e.classList.remove(`active`)}),t.classList.toggle(`active`)})}),document.addEventListener(`click`,e=>{document.querySelectorAll(`.social-dropdown-wrapper.active`).forEach(t=>{t.contains(e.target)||t.classList.remove(`active`)})})}function O(e){let t=document.createElement(`div`);if(t.style.cssText=`
    ...
    `,e.appendChild(t),document.body.appendChild(e),setTimeout(()=>{e.classList.add(`visible`),t.classList.add(`visible`)},50);let n=()=>{e.classList.remove(`visible`),t.classList.remove(`visible`),setTimeout(()=>{e.parentNode&&e.parentNode.removeChild(e)},400)};document.getElementById(`ios-popup-btn-cancel`).addEventListener(`click`,n),document.getElementById(`ios-popup-btn-x`).addEventListener(`click`,n),e.addEventListener(`click`,t=>{t.target===e&&n()}),document.getElementById(`ios-popup-btn-continue`).addEventListener(`click`,()=>{navigator.clipboard.writeText(`rwoaln`).catch(e=>console.log(`Clipboard error:`,e)),window.open(`https://apps.apple.com/in/app/myinstitute/id1472483563`,`_blank`),n()})}function M(e,t,n){document.title=e;let r=document.querySelector(`meta[name="description"]`);if(r||(r=document.createElement(`meta`),r.name=`description`,document.head.appendChild(r)),r.content=t,n){let e=document.querySelector(`link[rel="canonical"]`);e||(e=document.createElement(`link`),e.rel=`canonical`,document.head.appendChild(e)),e.href=n}}var N={},P={"/":{load:async()=>{let[{renderBanner:e,initBanner:t},{renderPopularCourses:n},{renderFreeDemo:r},{renderFaculty:i,initFaculty:a},{renderHomeReviews:o,initHomeReviews:s},{renderImpact:c,initImpact:u},{renderAppDownload:d}]=await Promise.all([l(()=>import(`./banner-C-YUuRnB.js`),[]),l(()=>import(`./popularCourses-D1oW3aV3.js`),[]),l(()=>import(`./freeDemo-DhfFoN_s.js`),[]),l(()=>import(`./faculty-x2ATcqUv.js`),[]),l(()=>import(`./homeReviews-DZJizj6C.js`),[]),l(()=>import(`./impact-BAudM9QS.js`),[]),l(()=>import(`./appDownload-N3TINJ8Z.js`),[])]);return{render:()=>e()+n()+r()+i()+o()+c()+d(),postRender:()=>{t(),a(),s(),u(),F(),M(`Best Online Coaching for IIT-JEE, NEET & Class 6-10 | EduRain`,`EduRain is an online education platform providing academic learning and exam preparation for Class 6–12, Foundation, NEET and IIT-JEE.`,`https://www.edurain.in/`)}}}},"/courses":{load:async()=>{let{renderCourses:e,initCourses:t}=await l(async()=>{let{renderCourses:e,initCourses:t}=await import(`./courses-BUfp9lGm.js`);return{renderCourses:e,initCourses:t}},__vite__mapDeps([0,1,2]));return{render:()=>e(),postRender:()=>{t(),M(`Explore Our All Courses – IIT JEE, NEET & Foundation (Class 6-10)`,`Explore IIT JEE, NEET & Foundation courses for Class 6-10 with expert faculty, structured curriculum & proven results. Take the first step toward success`,`https://www.edurain.in/courses`)}}}},"/blogs":{load:async()=>{let{renderBlogs:e,initBlogs:t}=await l(async()=>{let{renderBlogs:e,initBlogs:t}=await import(`./blogs-CyybONT9.js`);return{renderBlogs:e,initBlogs:t}},__vite__mapDeps([3,4,5,6,1]));return{render:()=>e(),postRender:()=>{t(),(window.location.pathname===`/blogs`||window.location.pathname===`/blogs/`)&&M(`IIT JEE, NEET & Foundation Blogs | EduRain`,`Read blogs on IIT JEE preparation, NEET exam strategy, and Foundation (6th-10th) study guides`,`https://www.edurain.in/blogs`)}}}},"/about-us":{load:async()=>{let{renderAbout:e}=await l(async()=>{let{renderAbout:e}=await import(`./about-By50-aw2.js`);return{renderAbout:e}},[]);return{render:()=>e(),postRender:()=>M(`About Us | EduRain's Mission to Make Learning Accessible`,`At EduRain, our mission is to make quality education accessible for every student from Class 6-10 foundation to IIT-JEE & NEET success. Know our story`,`https://www.edurain.in/about-us`)}}},"/about-new":{load:async()=>{let{renderAbout:e,initAboutNew:t}=await l(async()=>{let{renderAbout:e,initAboutNew:t}=await import(`./about-new-B80N6-lW.js`);return{renderAbout:e,initAboutNew:t}},[]);return{render:()=>e(),postRender:()=>{M(`About Us (New) | EduRain`,`Check out our new About Us page.`,`https://www.edurain.in/about-new`),t&&t()}}}},"/contact-us":{load:async()=>{let{renderContact:e,initContact:t}=await l(async()=>{let{renderContact:e,initContact:t}=await import(`./contact-HzPmidJV.js`);return{renderContact:e,initContact:t}},[]);return{render:()=>e(),postRender:()=>{t(),M(`Contact Us | Get in Touch with EduRain`,`Have questions about our courses for Class 6-10, IIT-JEE or NEET? Contact EduRain's team for admissions support, course details or a free demo class`,`https://www.edurain.in/contact-us`)}}}},"/privacy":{load:async()=>{let{renderPrivacy:e}=await l(async()=>{let{renderPrivacy:e}=await import(`./privacy-B7H0r27C.js`);return{renderPrivacy:e}},[]);return{render:()=>e(),postRender:()=>M(`Privacy Policy - EduRain`,`Privacy policy of EduRain`,`https://www.edurain.in/privacy`)}}},"/terms":{load:async()=>{let{renderTerms:e}=await l(async()=>{let{renderTerms:e}=await import(`./terms-CSkLg5fH.js`);return{renderTerms:e}},[]);return{render:()=>e(),postRender:()=>M(`Terms and Conditions - EduRain`,`Terms and conditions of use for Edurain`)}}},"/sitemap":{load:async()=>{let{renderSitemap:e}=await l(async()=>{let{renderSitemap:e}=await import(`./sitemap-Dlz_MZbc.js`);return{renderSitemap:e}},[]);return{render:()=>e(),postRender:()=>M(`Sitemap - EduRain`,`Sitemap for EduRain`)}}},"/courses/iit-jee":{load:async()=>{let[{renderJEECourses:e},{initFAQ:t}]=await Promise.all([l(()=>import(`./categoryCourses-Ddtl866C.js`),__vite__mapDeps([7,1,2])),l(()=>import(`./faq-Bo7AT8JC.js`),[])]);return{render:()=>e(),postRender:()=>{t(),M(`Best IIT JEE Online Coaching for JEE Main & Advanced | EduRain`,`Crack IIT JEE with EduRain: live classes, expert faculty, and structured material for complete JEE Main & Advanced exam preparation`,`https://www.edurain.in/courses/iit-jee`),window.anime&&window.anime({targets:`.er-anime-reveal`,translateY:[40,0],opacity:[0,1],easing:`easeOutExpo`,duration:1200,delay:window.anime.stagger(150,{start:300})})}}}},"/courses/neet":{load:async()=>{let[{renderNEETCourses:e},{initFAQ:t}]=await Promise.all([l(()=>import(`./categoryCourses-Ddtl866C.js`),__vite__mapDeps([7,1,2])),l(()=>import(`./faq-Bo7AT8JC.js`),[])]);return{render:()=>e(),postRender:()=>{t(),M(`NEET 2027-28 Complete Online Preparation with EduRain`,`Start your NEET 2027-28 online preparation with EduRain: live classes, expert faculty, and structured NCERT-based material with regular tests.`,`https://www.edurain.in/courses/neet`),window.anime&&window.anime({targets:`.er-anime-reveal`,translateY:[40,0],opacity:[0,1],easing:`easeOutExpo`,duration:1200,delay:window.anime.stagger(150,{start:300})})}}}},"/courses/foundation":{load:async()=>{let[{renderFoundationCourses:e},{initFAQ:t}]=await Promise.all([l(()=>import(`./categoryCourses-Ddtl866C.js`),__vite__mapDeps([7,1,2])),l(()=>import(`./faq-Bo7AT8JC.js`),[])]);return{render:()=>e(),postRender:()=>{t(),M(`Best Online Coaching for Classes 6 to 10 | Live Interactive Classes`,`Live online classes for Class 6 to 10 with expert-led Math, Science & more: building a strong IIT JEE & NEET foundation. Interactive learning, real results`,`https://www.edurain.in/courses/foundation`),window.anime&&window.anime({targets:`.er-anime-reveal`,translateY:[40,0],opacity:[0,1],easing:`easeOutExpo`,duration:1200,delay:window.anime.stagger(150,{start:300})})}}}},"/blogadmin":{load:async()=>{let{renderBlogAdmin:e,initBlogAdmin:t}=await l(async()=>{let{renderBlogAdmin:e,initBlogAdmin:t}=await import(`./blogAdmin-BqCXeWJR.js`);return{renderBlogAdmin:e,initBlogAdmin:t}},__vite__mapDeps([8,4,5,6,1]));return{render:()=>e(),postRender:()=>t()}}},"/blogadmin/login":{load:async()=>{let{renderBlogAdminLogin:e,initBlogAdminLogin:t}=await l(async()=>{let{renderBlogAdminLogin:e,initBlogAdminLogin:t}=await import(`./blogAdminLogin-Cblq4WmZ.js`);return{renderBlogAdminLogin:e,initBlogAdminLogin:t}},__vite__mapDeps([9,4,5,6]));return{render:()=>e(),postRender:()=>t()}}},"/study":{load:async()=>(window.location.href=`/study/`,{render:()=>``,postRender:()=>{}})}};function F(){let e=document.querySelectorAll(`.er-reveal`);if(!e.length)return;let t=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&(e.target.classList.add(`visible`),t.unobserve(e.target))})},{threshold:.12});e.forEach(e=>t.observe(e))}window.prefetchRoute=e=>{P[e]&&!N[e]&&P[e].load()};var I=e=>{window.history.pushState({},``,e),window.renderRoute&&window.renderRoute()},L=()=>{let e=document.getElementById(`app`),t=new URLSearchParams(window.location.search).get(`p`);t&&window.history.replaceState(null,null,t),document.body.addEventListener(`mouseover`,e=>{let t=e.target.closest(`a`);if(t&&t.href)try{let e=new URL(t.href);if(e.origin===window.location.origin){let t=e.pathname;t.endsWith(`/`)&&t!==`/`&&(t=t.slice(0,-1)),window.prefetchRoute(t)}}catch{}}),document.body.addEventListener(`click`,e=>{if(e.defaultPrevented)return;let t=e.target.closest(`a`);if(t&&t.href){if(t.getAttribute(`href`)===`#`)return;try{let n=new URL(t.href);if(n.origin===window.location.origin){if(t.target===`_blank`||n.pathname.startsWith(`/jeecourse`)||n.pathname.startsWith(`/neetcourse`)||n.pathname.startsWith(`/foundationcourse`)||n.pathname.startsWith(`/study`))return;e.preventDefault(),I(n.pathname)}}catch{}}}),window.renderRoute=async()=>{let t=window.location.pathname,n=t;t===``||t===`/`?t=`/`:t.endsWith(`/`)&&(t=t.slice(0,-1)),n!==t&&t!==`/`&&window.history.replaceState(window.history.state,``,t+window.location.search+window.location.hash);let r=P[t];!r&&t.startsWith(`/blogs/`)&&(r=P[`/blogs`]);let i;r?(N[t]||(N[t]=await r.load()),i=N[t]):i={render:()=>`<div class="page-404"><h1>404</h1><p>Page not found</p><a href="/" class="btn btn-accent">Go Home</a></div>`,postRender:()=>{}};let a=t.startsWith(`/blogadmin`)||t.startsWith(`/study`),o=a?``:w(),s=a?``:E();t.startsWith(`/blogadmin`);let c=i.render();e.innerHTML=`
      ${o}
      <main class="main-content fade-in-section" ${a?`style="padding:0; margin:0; max-width: 100%;"`:``}>
        ${c}
      </main>
      ${s}
      
    `,requestAnimationFrame(()=>{let t=e.querySelector(`.main-content`);t&&t.classList.add(`visible`)}),document.querySelectorAll(`.nav-link`).forEach(e=>{try{let n=new URL(e.href).pathname,r=n.endsWith(`/`)&&n!==`/`?n.slice(0,-1):n;e.classList.toggle(`active`,r===t)}catch{}}),window.scrollTo({top:0,behavior:`instant`}),T(),k(),D(),A(),i.postRender(),window.observeFadeElements&&window.observeFadeElements()},window.addEventListener(`popstate`,window.renderRoute),window.renderRoute()};function R(){let e=document.createElement(`div`);e.id=`er-fab-container`,e.innerHTML=`
