import{C as e,S as t,_ as n,a as r,b as i,c as a,d as o,f as s,g as c,h as l,i as u,l as d,m as f,n as p,o as m,p as h,r as g,s as _,t as v,u as y,v as b,w as x,x as S,y as C}from"./vendor-uE_UooD1.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var w=x({apiKey:`AIzaSyBLw5eneJGCi4-YshAf5wgBA-yDT8o70Mc`,authDomain:`edurain-pvt.firebaseapp.com`,projectId:`edurain-pvt`,storageBucket:`edurain-pvt.firebasestorage.app`,messagingSenderId:`5660601224`,appId:`1:5660601224:web:e12194bc33e38cd1e8e83d`,measurementId:`G-JL0D0KVQYZ`}),T=C(w),E=c(w),D=g(w),O=async(e,t,r)=>{try{await o(l(E,`users`,e),{name:t,email:r,created_at:n()})}catch(e){throw Error(`Could not save user data: `+e.message)}},ee=async(e,t,r)=>{try{await m(f(E,`contacts`),{name:e,email:t,message:r,created_at:n()})}catch(e){throw Error(`Could not send message: `+e.message)}},te=async(t,n,r)=>{try{let i=(await b(T,n,r)).user;return await e(i,{displayName:t}),await O(i.uid,t,n),i}catch(e){throw Error(e.message||`Registration failed`)}},ne=async(e,t)=>{try{return(await S(T,e,t)).user}catch(e){throw Error(e.message||`Login failed`)}},re=async()=>{try{await t(T)}catch(e){throw Error(e.message||`Logout failed`)}},k=e=>i(T,e);function A(){return`
    ...
    `}function N(){document.querySelectorAll(`.social-dropdown-toggle`).forEach(e=>{let t=e.closest(`.social-dropdown-wrapper`);t&&e.addEventListener(`click`,e=>{e.stopPropagation(),document.querySelectorAll(`.social-dropdown-wrapper.active`).forEach(e=>{e!==t&&e.classList.remove(`active`)}),t.classList.toggle(`active`)})}),document.addEventListener(`click`,e=>{document.querySelectorAll(`.social-dropdown-wrapper.active`).forEach(t=>{t.contains(e.target)||t.classList.remove(`active`)})})}var P=[{id:`c1`,title:`Dropper JEE 2027 Batch`,instructor:`Ms.Ritu , Mr.Diwakar ,Mr.Banarjee`,rating:4.2,students:500,price:`₹12,520`,thumbnail:`https://cdn.phototourl.com/free/2026-08-14-50ced64b-6d99-422d-91fb-8a62bfa1e137.webp`,category:`JEE`,description:`Master the fundamentals of Calculus and Linear Algebra. Perfect for engineering aspirants.`,link:`https://courses.edurain.in/courses/849750`},{id:`c2`,title:`CLASS 11TH MATHEMATICS`,instructor:`Mr.Banarjee Sir`,rating:4.5,students:302,price:`₹2,520`,thumbnail:`https://cdn.phototourl.com/free/2026-08-14-105e8fdd-49f2-4184-9f47-9c66ccfe1665.webp`,category:`JEE`,description:`Master the fundamentals of Calculus and Linear Algebra. Perfect for engineering aspirants.`,link:`https://courses.edurain.in/courses/857872`},{id:`c6`,title:`CLASS 12TH MATHEMATICS`,instructor:`Mr.Banarjee Sir`,rating:4.8,students:132,price:`₹2,520`,thumbnail:`https://xrmvmgtcgjjhljcmnhsn.supabase.co/storage/v1/object/public/images/1786707733989_84534946_unnamed.webp`,category:`JEE`,description:`Crack product-based company interviews with robust DSA concepts.`,link:`https://courses.edurain.in/courses/857872`},{id:`c7`,title:`CLASS 11TH PCB(NEET)`,instructor:`Ms.Ritu , Mr.Diwakar ,Mr.Nitin`,rating:4.5,students:620,price:`₹5,020`,thumbnail:`https://xrmvmgtcgjjhljcmnhsn.supabase.co/storage/v1/object/public/images/1786707980934_915096e8_unnamed.webp`,category:`NEET`,description:`Clear your basics in Organic Chemistry with reaction mechanisms and practical examples.`,link:`https://courses.edurain.in/courses/855893`},{id:`c8`,title:`DROPPER NEET 2027 BATCH`,instructor:`Ms.Ritu , Mr.Diwakar ,Mr.Nitin`,rating:4.7,students:1800,price:`₹12,520`,thumbnail:`https://xrmvmgtcgjjhljcmnhsn.supabase.co/storage/v1/object/public/images/1786708172893_14fde1b1_unnamed.webp`,category:`NEET`,description:`Boost your calculation speed using ancient Vedic Math techniques.`,link:`https://courses.edurain.in/courses/849750`},{id:`c9`,title:`CLASS 11TH PCB(JEE)`,instructor:`Ms.Ritu , Mr.Diwakar ,Mr.Banarjee`,rating:4.9,students:1200,price:`₹5,020`,thumbnail:`https://xrmvmgtcgjjhljcmnhsn.supabase.co/storage/v1/object/public/images/1786708237356_3e4e42b7_unnamed.webp`,category:`JEE`,description:`A complete beginner's guide to understanding, reading, and speaking Hindi.`,link:`https://courses.edurain.in/courses/846771`},{id:`c10`,title:`CLASS 8TH`,instructor:`Manoj Sir,Khushbu ma'am ,Nandini ma'am,Sujeet sir`,rating:4.8,students:1120,price:`₹4,520`,thumbnail:`https://xrmvmgtcgjjhljcmnhsn.supabase.co/storage/v1/object/public/images/1786708300269_af0cced2_unnamed.webp`,category:`FOUNDATION`,description:`Step into the world of AI with practical Machine Learning algorithms and tools.`,link:`https://courses.edurain.in/courses/830945`},{id:`c11`,title:`CLASS 7TH`,instructor:`Manoj Sir,Khushbu ma'am ,Nandini ma'am,Sujeet sir`,rating:4.9,students:320,price:`₹3,520`,thumbnail:`https://xrmvmgtcgjjhljcmnhsn.supabase.co/storage/v1/object/public/images/1786708358028_b62b8226_unnamed.webp`,category:`NEET`,description:`Comprehensive biology course designed specifically for medical aspirants targeting NEET.`,link:`https://courses.edurain.in/courses/830943`},{id:`c12`,title:`CLASS 12TH English`,instructor:`Mr.Manoj Sir`,rating:4.1,students:126,price:`₹2,520`,thumbnail:`https://xrmvmgtcgjjhljcmnhsn.supabase.co/storage/v1/object/public/images/1786708411693_43d53417_unnamed.webp`,category:`ALL`,description:`Comprehensive biology course designed specifically for medical aspirants targeting NEET.`,link:`https://courses.edurain.in/courses/830941`},{id:`c13`,title:`CLASS 6TH`,instructor:`Manoj Sir,Khushbu ma'am ,Nandini ma'am,Sujeet sir`,rating:4.6,students:234,price:`₹3,520`,thumbnail:`https://xrmvmgtcgjjhljcmnhsn.supabase.co/storage/v1/object/public/images/1786708440388_cfb42854_unnamed.webp`,category:`FOUNDATION`,description:`Comprehensive biology course designed specifically for medical aspirants targeting NEET.`,link:`https://courses.edurain.in/courses/830607`},{id:`c14`,title:`CLASS 11TH ENGLISH`,instructor:`Mr.Manoj Sir`,rating:4.3,students:105,price:`₹2,520`,thumbnail:`https://xrmvmgtcgjjhljcmnhsn.supabase.co/storage/v1/object/public/images/1786708511517_f37d966c_unnamed.webp`,category:`ENGLISH`,description:`Comprehensive biology course designed specifically for medical aspirants targeting NEET.`,link:`https://courses.edurain.in/courses/828615`},{id:`c15`,title:`CLASS 9TH SUPER CAMPIONS`,instructor:`Manoj Sir,Khushbu ma'am ,Nandini ma'am,Sujeet sir`,rating:4.4,students:370,price:`₹4,520`,thumbnail:`https://xrmvmgtcgjjhljcmnhsn.supabase.co/storage/v1/object/public/images/1786708557261_08ee3912_unnamed.webp`,category:`FOUNDATION`,description:`Comprehensive biology course designed specifically for medical aspirants targeting NEET.`,link:`https://courses.edurain.in/courses/814577`},{id:`c16`,title:`CLASS 10TH DISHA BATCH`,instructor:`Manoj Sir,Khushbu ma'am ,Nandini ma'am,Sujeet sir`,rating:4.7,students:249,price:`₹4,020`,thumbnail:`https://xrmvmgtcgjjhljcmnhsn.supabase.co/storage/v1/object/public/images/1786708593166_35c415e1_unnamed.webp`,category:`FOUNDATION`,description:`Comprehensive biology course designed specifically for medical aspirants targeting NEET.`,link:`https://courses.edurain.in/courses/814204`},{id:`c17`,title:`TARGET JEE 2027 -12TH CLASS BATCH`,instructor:`Ms.Ritu , Mr.Diwakar ,Mr.Banarjee`,rating:4.45,students:425,price:`₹4,820`,thumbnail:`https://xrmvmgtcgjjhljcmnhsn.supabase.co/storage/v1/object/public/images/1786708692702_1d2899f4_unnamed.webp`,category:`JEE`,description:`Comprehensive biology course designed specifically for medical aspirants targeting NEET.`,link:`https://courses.edurain.in/courses/814178`},{id:`c18`,title:`NEET WHITE COAT 2027 -CLASS 12th`,instructor:`Ms.Ritu , Mr.Diwakar ,Mr.Nitin`,rating:4.9,students:770,price:`₹4,820`,thumbnail:`https://xrmvmgtcgjjhljcmnhsn.supabase.co/storage/v1/object/public/images/1786708771621_b592371a_unnamed.webp`,category:`NEET`,description:`Comprehensive biology course designed specifically for medical aspirants targeting NEET.`,link:`https://courses.edurain.in/courses/814170`},{id:`c19`,title:`MISSION NEET 3.0 BATCH 2028`,instructor:`Ms.Ritu , Mr.Diwakar ,Mr.Nitin`,rating:4.1,students:505,price:`₹9,019`,thumbnail:`https://xrmvmgtcgjjhljcmnhsn.supabase.co/storage/v1/object/public/images/1786708845701_d57d2524_unnamed.webp`,category:`NEET`,description:`Comprehensive biology course designed specifically for medical aspirants targeting NEET.`,link:`https://courses.edurain.in/courses/814073`},{id:`c23`,title:`JEE Mantra 3.0 Batch 2028`,instructor:`Ms.Ritu , Mr.Diwakar ,Mr.Banarjee`,rating:4.89,students:890,price:`₹9,019`,thumbnail:`https://xrmvmgtcgjjhljcmnhsn.supabase.co/storage/v1/object/public/images/1786709213605_9dd96992_unnamed.webp`,category:`JEE`,description:`Comprehensive biology course designed specifically for medical aspirants targeting NEET.`,link:`https://courses.edurain.in/courses/813811`}];function F(){return`
        <section class="courses-section" id="courses-page">
            ...
            <div class="courses-grid" id="courses-grid">
                ${P.map(e=>{let t=`⭐`.repeat(Math.round(e.rating)),n=e.students>=1e3?`${(e.students/1e3).toFixed(1)}K`:e.students;return`
    ...
    `}function I(){let e=document.querySelectorAll(`.course-card`);e.forEach(e=>{e.classList.add(`fade-in-section`,`visible`)}),e.forEach(e=>{e.style.cursor=`pointer`,e.addEventListener(`click`,t=>{if(t.target.closest(`a`))return;let n=e.getAttribute(`data-link`);n&&n!==`#`&&window.open(n,`_blank`,`noopener,noreferrer`)})})}var L=[`All Blogs`,`Study Hacks`,`JEE Mains PYQ`,`NEET Test Series`,`CBSE Class 10 PYQ`,`CBSE Class 12 PYQ`,`Foundation 9th-10th`],R=[];function z(){return`
    ...
    `}function B(e){return!e||e.length===0?`
        ...
        <div class="er-pw-blogs-grid">
            ...
            <div class="er-pw-blog-card glass-card fade-in-section" data-blog-id="${e.id}" style="cursor:pointer;">
                <div class="er-pw-card-cover">
                    <img src="${e.coverImage||`/images/default-blog.jpg`}" alt="${e.title}" class="er-pw-card-img" style="width:100%; height:200px; object-fit:cover;" />
    ...
    `}async function V(){let e=document.getElementById(`er-blog-search-input`),t=document.getElementById(`er-tags-container`),n=document.getElementById(`er-blogs-grid-container`),r=document.getElementById(`blog-list-view`),i=document.getElementById(`blog-reader-view`),o=document.getElementById(`pw-reader-main-content`),s=document.getElementById(`pw-reader-related-container`);if(!n||!i)return;let c=`All Blogs`,l=``;try{R=(await a(y(f(E,`blogs`),h(`status`,`==`,`published`),d(`date`,`desc`)))).docs.map(e=>({id:e.id,...e.data()})),u();let e=window.location.hash.split(`?`)[0].split(`/`);if(e.length>1&&e[0]===`#blogs`){let t=e[1];p(t,!1)}}catch(e){console.error(`Error fetching blogs:`,e),n.innerHTML=`<div style="text-align: center; padding: 2rem; color: #ef4444;">Failed to load blogs. Please try again later.</div>`}function u(){let e=R.filter(e=>{let t=Array.isArray(e.tags)?e.tags.map(e=>e.toLowerCase()):(e.tag||``).toLowerCase().split(`,`).map(e=>e.trim()),n=c===`All Blogs`||e.category&&e.category.toLowerCase().includes(c.toLowerCase())||t.includes(c.toLowerCase())||e.title&&e.title.toLowerCase().includes(c.toLowerCase()),r=!l||e.title&&e.title.toLowerCase().includes(l.toLowerCase())||e.excerpt&&e.excerpt.toLowerCase().includes(l.toLowerCase())||e.category&&e.category.toLowerCase().includes(l.toLowerCase());return n&&r});n.innerHTML=B(e),g()}e&&e.addEventListener(`input`,e=>{l=e.target.value.trim(),u()}),t&&t.addEventListener(`click`,e=>{let n=e.target.closest(`.er-tag-pill`);n&&(t.querySelectorAll(`.er-tag-pill`).forEach(e=>e.classList.remove(`active`)),n.classList.add(`active`),c=n.getAttribute(`data-tag`),u())});function p(e,t=!0){let n=R.find(t=>t.id===e);if(!n)return;let a=`Recently`;n.date&&(a=(n.date.toDate?n.date.toDate():new Date(n.date)).toLocaleDateString(`en-IN`,{year:`numeric`,month:`long`,day:`numeric`}));let c=``;if(c=Array.isArray(n.content)?n.content.map(e=>e.type===`heading`?`<h3 class="pw-article-h3">${e.text}</h3>`:`<p class="pw-article-p">${e.text}</p>`).join(``):`<div class="quill-content">${n.content||`<p class="pw-article-p">${n.excerpt}</p>`}</div>`,n.seo){document.title=n.seo.metaTitle||n.title;let e=document.querySelector(`meta[name="description"]`);e&&(e.content=n.seo.metaDescription||n.excerpt)}o.innerHTML=`
        ...
        `;let l=R.filter(e=>e.id!==n.id).slice(0,3);s.innerHTML=`
        ...
        `,r.style.display=`none`,i.style.display=`block`;let u=document.getElementById(`blogs`);u?u.scrollIntoView({behavior:`smooth`}):window.scrollTo({top:0,behavior:`smooth`}),document.getElementById(`btn-bc-blogs`)?.addEventListener(`click`,m),document.getElementById(`btn-close-modal-bottom`)?.addEventListener(`click`,m),s.querySelectorAll(`.btn-open-blog`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation();let n=e.getAttribute(`data-blog-id`);n&&p(n)})}),t&&history.pushState(null,null,`#blogs/`+n.id)}function m(){i.style.display=`none`,r.style.display=`block`,history.pushState(null,null,`#blogs`),document.title=`IIT JEE, NEET & Foundation Blogs | EduRain`;let e=document.querySelector(`meta[name="description"]`);e&&(e.content=`Read blogs on IIT JEE preparation, NEET exam strategy, and Foundation (6th-10th) study guides`);let t=document.getElementById(`blogs`);t&&t.scrollIntoView({behavior:`smooth`})}function g(){n.querySelectorAll(`.er-pw-blog-card`).forEach(e=>{e.addEventListener(`click`,t=>{t.preventDefault(),t.stopPropagation();let n=e.getAttribute(`data-blog-id`);n&&p(n)})})}}function H(){return`
            ...
            <div class="reviews-carousel">
                ...
                <div class="carousel-viewport">
                    <div class="carousel-track" id="review-track">
                        ${U.map((e,t)=>{let n=[`linear-gradient(135deg, #10b981 0%, #059669 100%)`,`linear-gradient(135deg, #3b82f6 0%, #1d4ed8 100%)`,`linear-gradient(135deg, #ec4899 0%, #be185d 100%)`,`linear-gradient(135deg, #f59e0b 0%, #d97706 100%)`,`linear-gradient(135deg, #8b5cf6 0%, #6d28d9 100%)`,`linear-gradient(135deg, #06b6d4 0%, #0891b2 100%)`];return`
    ...
    `}function ie(){let e=document.getElementById(`architecture-modal`),t=document.getElementById(`modal-close-btn`),n=document.getElementById(`modal-title`),r=document.getElementById(`mermaid-diagram-container`);document.querySelectorAll(`.view-architecture-btn`).forEach(t=>{t.addEventListener(`click`,()=>{let i=t.dataset.project,a=`System Architecture`,o=``;if(i===`credit-risk`?(a=`💳 Credit Risk Assessment — Multi-Agent Architecture`,o=`
    graph TD
    ...
    `}function ce(e){let t=`⭐`.repeat(Math.round(e.rating)),n=e.students>=1e3?`${(e.students/1e3).toFixed(1)}K`:e.students;return`
    ...
    `}function Z(e,t,n){let r=P.filter(e=>e.category===n),i=r.length>0?r.map(ce).join(``):`<p style="text-align: center; width: 100%; color: var(--text-muted);">No courses available in this category yet.</p>`;return`
    ...
    `}function me(){let e=document.getElementById(`er-blog-admin-wrapper`),o=document.getElementById(`er-admin-auth-loading`);if(!e)return;let c,h=i(T,t=>{t&&t.email===`edurainseowork@gmail.com`?(o.style.display=`none`,e.style.display=`flex`,g(),C()):window.location.hash=`#blogadmin/login`});document.getElementById(`admin-logout-btn`)?.addEventListener(`click`,async()=>{await t(T),window.location.hash=`#blogadmin/login`});function g(){let e=document.getElementById(`view-all-blogs`),t=document.getElementById(`view-add-blog`),r=document.getElementById(`nav-all-blogs`),i=document.getElementById(`nav-add-blog`),a=document.getElementById(`btn-create-new`);function o(n){n===`all`?(e.style.display=`block`,t.style.display=`none`,r.style.background=`#16a34a`,r.style.color=`white`,i.style.background=`transparent`,i.style.color=`#cbd5e1`,C()):(e.style.display=`none`,t.style.display=`block`,i.style.background=`#16a34a`,i.style.color=`white`,r.style.background=`transparent`,r.style.color=`#cbd5e1`,c||b())}r.addEventListener(`click`,()=>o(`all`)),i.addEventListener(`click`,()=>{S(),o(`add`)}),a.addEventListener(`click`,()=>{S(),o(`add`)});let s=document.getElementById(`btn-migrate-blogs`);s.addEventListener(`click`,async()=>{if(confirm(`Are you sure you want to migrate JSON blogs to Firestore? This will push all blogs from blogs.json to the database.`)){s.textContent=`Migrating...`,s.disabled=!0;try{let e=f(E,`blogs`);for(let t of fe){let r={},i=``;i=Array.isArray(t.content)?t.content.map(e=>e.type===`heading`?`<h3 class="pw-article-h3">${e.text}</h3>`:`<p class="pw-article-p">${e.text}</p>`).join(``):t.content||`<p class="pw-article-p">${t.excerpt||``}</p>`,await m(e,{title:t.title||`Untitled`,excerpt:t.excerpt||``,content:i,status:t.isPublished===!1?`draft`:`published`,coverImage:t.coverImage||`/images/default-blog.jpg`,category:t.category||`General`,tags:t.tag?t.tag.split(`,`).map(e=>e.trim()):[],author:t.author||`EduRain Team`,date:t.date?new Date(t.date):n(),seo:r,updatedAt:n()})}alert(`Migration Complete! Blogs are now in Firestore.`),C()}catch(e){console.error(`Migration failed:`,e),alert(`Migration failed! `+e.message)}s.textContent=`Migrate JSON Blogs`,s.disabled=!1}}),document.getElementById(`admin-blog-form`).addEventListener(`submit`,O)}function b(){c=new v(`#quill-editor`,{theme:`snow`,modules:{toolbar:{container:[[{header:[1,2,3,4,5,6,!1]}],[`bold`,`italic`,`underline`,`strike`],[{color:[]},{background:[]}],[{list:`ordered`},{list:`bullet`}],[`link`,`image`,`video`],[`clean`]],handlers:{image:x}}}})}function x(){let e=document.createElement(`input`);e.setAttribute(`type`,`file`),e.setAttribute(`accept`,`image/*`),e.click(),e.onchange=async()=>{let t=e.files[0];if(/^image\//.test(t.type)){let e=r(u(D,`blog_images/${Date.now()}_${t.name}`),t);e.on(`state_changed`,e=>{},e=>{console.error(`Image upload failed:`,e),alert(`Image upload failed!`)},async()=>{let t=await p(e.snapshot.ref),n=c.getSelection();c.insertEmbed(n.index,`image`,t)})}else alert(`You can only upload images.`)}}function S(){document.getElementById(`admin-blog-form`).reset(),document.getElementById(`blog-id`).value=``,document.getElementById(`editor-title`).textContent=`Create New Blog`,document.getElementById(`save-status`).textContent=``,c&&(c.root.innerHTML=``)}async function C(){let e=document.getElementById(`admin-blogs-list`);try{let t=await a(y(f(E,`blogs`),d(`date`,`desc`)));if(t.empty){e.innerHTML=`<tr><td colspan="5" style="padding: 2rem; text-align: center;">No blogs found. Create one!</td></tr>`;return}let n=``;t.forEach(e=>{let t=e.data(),r=e.id,i=t.date?.toDate?t.date.toDate().toLocaleDateString():`Draft`,a=t.status===`published`?`<span style="background:#16a34a; padding: 4px 8px; border-radius: 4px; font-size: 0.8rem;">Published</span>`:`<span style="background:#94a3b8; padding: 4px 8px; border-radius: 4px; font-size: 0.8rem;">Draft</span>`;n+=`
                ...
                `}),e.innerHTML=n,document.querySelectorAll(`.btn-edit-blog`).forEach(e=>{e.addEventListener(`click`,async e=>{await w(e.target.getAttribute(`data-id`),t)})}),document.querySelectorAll(`.btn-delete-blog`).forEach(e=>{e.addEventListener(`click`,async e=>{let t=e.target.getAttribute(`data-id`);confirm(`Are you sure you want to delete this blog?`)&&(await _(l(E,`blogs`,t)),C())})})}catch(t){console.error(`Error loading blogs:`,t),e.innerHTML=`<tr><td colspan="5" style="padding: 2rem; text-align: center; color: #ef4444;">Error loading blogs. Check console.</td></tr>`}}async function w(e,t){let n=t.docs.find(t=>t.id===e);if(!n)return;let r=n.data();document.getElementById(`editor-title`).textContent=`Edit Blog`,document.getElementById(`blog-id`).value=e,document.getElementById(`blog-title`).value=r.title||``,document.getElementById(`blog-excerpt`).value=r.excerpt||``,document.getElementById(`blog-status`).value=r.status||`draft`,document.getElementById(`blog-cover`).value=r.coverImage||``,document.getElementById(`blog-category`).value=r.category||``,document.getElementById(`blog-tags`).value=(r.tags||[]).join(`, `),document.getElementById(`blog-author`).value=r.author||`EduRain Team`,r.seo&&(document.getElementById(`seo-title`).value=r.seo.metaTitle||``,document.getElementById(`seo-desc`).value=r.seo.metaDescription||``,document.getElementById(`seo-keyword`).value=r.seo.primaryKeyword||``),document.getElementById(`view-all-blogs`).style.display=`none`,document.getElementById(`view-add-blog`).style.display=`block`,document.getElementById(`nav-add-blog`).style.background=`#16a34a`,document.getElementById(`nav-add-blog`).style.color=`white`,document.getElementById(`nav-all-blogs`).style.background=`transparent`,document.getElementById(`nav-all-blogs`).style.color=`#cbd5e1`,c||b(),c.root.innerHTML=r.content||``}async function O(e){e.preventDefault();let t=document.getElementById(`btn-save-blog`),r=document.getElementById(`save-status`);t.disabled=!0,t.textContent=`Saving...`,r.textContent=``;try{let e=document.getElementById(`blog-id`).value,t={title:document.getElementById(`blog-title`).value,excerpt:document.getElementById(`blog-excerpt`).value,content:c.root.innerHTML,status:document.getElementById(`blog-status`).value,coverImage:document.getElementById(`blog-cover`).value,category:document.getElementById(`blog-category`).value,tags:document.getElementById(`blog-tags`).value.split(`,`).map(e=>e.trim()).filter(e=>e),author:document.getElementById(`blog-author`).value,seo:{metaTitle:document.getElementById(`seo-title`).value,metaDescription:document.getElementById(`seo-desc`).value,primaryKeyword:document.getElementById(`seo-keyword`).value},updatedAt:n()};if(e)await s(l(E,`blogs`,e),t),r.textContent=`Blog updated successfully!`,r.style.color=`#4ade80`;else{t.date=n();let e=await m(f(E,`blogs`),t);document.getElementById(`blog-id`).value=e.id,document.getElementById(`editor-title`).textContent=`Edit Blog`,r.textContent=`New blog published successfully!`,r.style.color=`#4ade80`}}catch(e){console.error(`Save Error:`,e),r.textContent=`Error saving blog: `+e.message,r.style.color=`#ef4444`}t.disabled=!1,t.textContent=`Save & Publish Blog`}return()=>h()}function he(){return`
    ...
    `}function ge(){let e=document.getElementById(`er-admin-login-form`),t=document.getElementById(`er-admin-email`),n=document.getElementById(`er-admin-password`),r=document.getElementById(`er-admin-login-error`),i=document.getElementById(`er-admin-login-btn`);e&&e.addEventListener(`submit`,async e=>{e.preventDefault();let a=t.value.trim(),o=n.value;if(a!==`edurainseowork@gmail.com`){r.textContent=`Unauthorized email address.`,r.style.display=`block`;return}i.textContent=`Authenticating...`,i.disabled=!0,r.style.display=`none`;try{await S(T,a,o),window.location.hash=`#blogadmin`}catch(e){console.error(`Login Error:`,e),r.textContent=`Invalid credentials or login failed.`,r.style.display=`block`,i.textContent=`Login to Dashboard`,i.disabled=!1}})}function _e(){return`
  ...
  `}function ve(){let e=document.getElementById(`er-slider-track`),t=document.querySelectorAll(`.er-dot`),n=document.querySelectorAll(`.er-slide`),r=document.getElementById(`er-arrow-prev`),i=document.getElementById(`er-arrow-next`);if(!e||!n.length)return;let a=0,o;function s(r){a=(r%n.length+n.length)%n.length,e.style.transform=`translateX(-${a*100}%)`,t.forEach((e,t)=>{e.classList.toggle(`er-dot-active`,t===a)})}function c(){l(),o=setInterval(()=>s(a+1),3500)}function l(){clearInterval(o)}t.forEach(e=>{e.addEventListener(`click`,()=>{l(),s(parseInt(e.dataset.index)),c()})}),r&&r.addEventListener(`click`,e=>{e.preventDefault(),l(),s(a-1),c()}),i&&i.addEventListener(`click`,e=>{e.preventDefault(),l(),s(a+1),c()});let u=0;e.addEventListener(`touchstart`,e=>{u=e.changedTouches[0].screenX},{passive:!0}),e.addEventListener(`touchend`,e=>{let t=u-e.changedTouches[0].screenX;Math.abs(t)>50&&(l(),s(a+(t>0?1:-1)),c())}),e.addEventListener(`mouseenter`,l),e.addEventListener(`mouseleave`,c),s(0),c()}function ye(){return`
    ...
    `}function Ee(){let e=document.querySelectorAll(`.er-count`),t=!1;function n(e){let t=parseInt(e.dataset.target,10),n=e.dataset.suffix||``,r=0;function i(e){return t>=1e6?(e/1e6).toFixed(0)+n:e.toLocaleString(`en-IN`)+n}e.textContent=i(0);let a=setInterval(()=>{r=Math.min(r+Math.ceil(t/80),t),e.textContent=i(r),r>=t&&(clearInterval(a),e.textContent=i(t),e.style.animation=`erCountPing 0.4s ease-out`,setTimeout(()=>{e.style.animation=``},400))},25)}let r=document.getElementById(`er-impact`);r&&(new IntersectionObserver(r=>{r.forEach(r=>{r.isIntersecting&&!t&&(t=!0,e.forEach(e=>n(e)))})},{threshold:.25}).observe(r),document.querySelectorAll(`.er-impact-card`).forEach(e=>{let t=e.querySelector(`.er-impact-bar`);e.addEventListener(`mouseenter`,()=>{t&&t.classList.add(`er-bar-expanded`),e.style.transform=`translateY(-6px)`}),e.addEventListener(`mouseleave`,()=>{t&&t.classList.remove(`er-bar-expanded`),e.style.transform=`translateY(0)`})}))}function De(){return`
    ...
    `,e.appendChild(t),document.body.appendChild(e),setTimeout(()=>{e.classList.add(`visible`),t.classList.add(`visible`)},50);let n=()=>{e.classList.remove(`visible`),t.classList.remove(`visible`),setTimeout(()=>{e.parentNode&&e.parentNode.removeChild(e)},400)};document.getElementById(`ios-popup-btn-cancel`).addEventListener(`click`,n),document.getElementById(`ios-popup-btn-x`).addEventListener(`click`,n),e.addEventListener(`click`,t=>{t.target===e&&n()}),document.getElementById(`ios-popup-btn-continue`).addEventListener(`click`,()=>{navigator.clipboard.writeText(`rwoaln`).catch(e=>console.log(`Clipboard error:`,e)),window.open(`https://apps.apple.com/in/app/myinstitute/id1472483563`,`_blank`),n()})}function $(e,t,n){document.title=e;let r=document.querySelector(`meta[name="description"]`);if(r||(r=document.createElement(`meta`),r.name=`description`,document.head.appendChild(r)),r.content=t,n){let e=document.querySelector(`link[rel="canonical"]`);e||(e=document.createElement(`link`),e.rel=`canonical`,document.head.appendChild(e)),e.href=n}}var ke={"/":{render:()=>_e()+ye()+be()+xe()+Ce()+Te()+De(),postRender:()=>{ve(),Se(),we(),Ee(),Ae(),$(`Best Online Coaching for IIT-JEE, NEET & Class 6-10 | EduRain`,`EduRain offers online coaching for Class 6-10, foundation courses, IIT-JEE preparation, NEET coaching, board exams and competitive exam preparation.`,`https://www.edurain.in/`)}},"/courses":{render:()=>F(),postRender:()=>{I(),$(`Explore Our All Courses – IIT JEE, NEET & Foundation (Class 6-10)`,`Explore IIT JEE, NEET & Foundation courses for Class 6-10 with expert faculty, structured curriculum & proven results. Take the first step toward success`,`https://www.edurain.in/courses`)}},"/blogs":{render:()=>z(),postRender:()=>{V(),$(`IIT JEE, NEET & Foundation Blogs | EduRain`,`Read blogs on IIT JEE preparation, NEET exam strategy, and Foundation (6th-10th) study guides`,`https://www.edurain.in/blogs`)}},"/journey":{render:()=>X(),postRender:()=>ie()},"/about-us":{render:()=>H(),postRender:()=>$(`About Us - EduRain`,`About EduRain`,`https://www.edurain.in/about-us`)},"/reviews":{render:()=>W(),postRender:()=>G()},"/contact-us":{render:()=>K(),postRender:()=>q()},"/privacy":{render:()=>ae(),postRender:()=>{}},"/terms":{render:()=>oe(),postRender:()=>$(`Terms and Conditions - EduRain`,`Terms and conditions of use for Edurain`)},"/sitemap":{render:()=>se(),postRender:()=>$(`Sitemap - EduRain`,`Sitemap for EduRain`)},"/courses/iit-jee":{render:()=>le(),postRender:()=>$(`Best IIT JEE Online Coaching for JEE Main & Advanced | EduRain`,`Crack IIT JEE with EduRain: live classes, expert faculty, and structured material for complete JEE Main & Advanced exam preparation`,`https://www.edurain.in/courses/iit-jee`)},"/courses/neet":{render:()=>ue(),postRender:()=>$(`NEET 2027-28 Complete Online Preparation with EduRain`,`Start your NEET 2027-28 online preparation with EduRain: live classes, expert faculty, and structured NCERT-based material with regular tests.`,`https://www.edurain.in/courses/neet`)},"/courses/foundation":{render:()=>de(),postRender:()=>$(`Best Online Coaching for Classes 6 to 10 | Live Interactive Classes`,`Live online classes for Class 6 to 10 with expert-led Math, Science & more: building a strong IIT JEE & NEET foundation. Interactive learning, real results`,`https://www.edurain.in/courses/foundation`)},"/blogadmin":{render:()=>pe(),postRender:()=>me()},"/blogadmin/login":{render:()=>he(),postRender:()=>ge()}};function Ae(){let e=document.querySelectorAll(`.er-reveal`);if(!e.length)return;let t=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&(e.target.classList.add(`visible`),t.unobserve(e.target))})},{threshold:.12});e.forEach(e=>t.observe(e))}var je=e=>{window.history.pushState({},``,e),window.renderRoute&&window.renderRoute()},Me=()=>{let e=document.getElementById(`app`),t=new URLSearchParams(window.location.search).get(`p`);t&&window.history.replaceState(null,null,t),document.body.addEventListener(`click`,e=>{if(e.defaultPrevented)return;let t=e.target.closest(`a`);if(t&&t.href){if(t.getAttribute(`href`)===`#`)return;try{let n=new URL(t.href);if(n.origin===window.location.origin){if(t.target===`_blank`||n.pathname.startsWith(`/jeecourse`)||n.pathname.startsWith(`/neetcourse`)||n.pathname.startsWith(`/foundationcourse`))return;e.preventDefault(),je(n.pathname)}}catch{}}}),window.renderRoute=()=>{let t=window.location.pathname;t===``||t===`/`?t=`/`:t.endsWith(`/`)&&(t=t.slice(0,-1));let n=ke[t]||{render:()=>`<div class="page-404"><h1>404</h1><p>Page not found</p><a href="/" class="btn btn-accent">Go Home</a></div>`,postRender:()=>{}},r=t.startsWith(`/blogadmin`)?``:A(),i=t.startsWith(`/blogadmin`)?``:M(),a=t.startsWith(`/blogadmin`)?``:J(),o=n.render();e.innerHTML=`
      ${r}
