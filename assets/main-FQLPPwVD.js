import{a as e,c as t,d as n,f as r,i,l as a,n as o,o as s,p as c,r as l,s as u,t as d,u as f}from"./vendor-4Cj2Jx5L.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var p=c({apiKey:`AIzaSyBLw5eneJGCi4-YshAf5wgBA-yDT8o70Mc`,authDomain:`edurain-pvt.firebaseapp.com`,projectId:`edurain-pvt`,storageBucket:`edurain-pvt.firebasestorage.app`,messagingSenderId:`5660601224`,appId:`1:5660601224:web:e12194bc33e38cd1e8e83d`,measurementId:`G-JL0D0KVQYZ`}),m=t(p),h=e(p),g=async(e,t,n)=>{try{await o(i(h,`users`,e),{name:t,email:n,created_at:s()})}catch(e){throw Error(`Could not save user data: `+e.message)}},_=async(e,t,n)=>{try{await d(l(h,`contacts`),{name:e,email:t,message:n,created_at:s()})}catch(e){throw Error(`Could not send message: `+e.message)}},v=async(e,t,n)=>{try{let i=(await u(m,t,n)).user;return await r(i,{displayName:e}),await g(i.uid,e,t),i}catch(e){throw Error(e.message||`Registration failed`)}},y=async(e,t)=>{try{return(await f(m,e,t)).user}catch(e){throw Error(e.message||`Login failed`)}},b=async()=>{try{await n(m)}catch(e){throw Error(e.message||`Logout failed`)}},ee=e=>a(m,e);function te(){return`
  ...
  `}function X(){let e=document.getElementById(`er-slider-track`),t=document.querySelectorAll(`.er-dot`),n=document.querySelectorAll(`.er-slide`),r=document.getElementById(`er-arrow-prev`),i=document.getElementById(`er-arrow-next`);if(!e||!n.length)return;let a=0,o;function s(r){a=(r%n.length+n.length)%n.length,e.style.transform=`translateX(-${a*100}%)`,t.forEach((e,t)=>{e.classList.toggle(`er-dot-active`,t===a)})}function c(){l(),o=setInterval(()=>s(a+1),3500)}function l(){clearInterval(o)}t.forEach(e=>{e.addEventListener(`click`,()=>{l(),s(parseInt(e.dataset.index)),c()})}),r&&r.addEventListener(`click`,e=>{e.preventDefault(),l(),s(a-1),c()}),i&&i.addEventListener(`click`,e=>{e.preventDefault(),l(),s(a+1),c()});let u=0;e.addEventListener(`touchstart`,e=>{u=e.changedTouches[0].screenX},{passive:!0}),e.addEventListener(`touchend`,e=>{let t=u-e.changedTouches[0].screenX;Math.abs(t)>50&&(l(),s(a+(t>0?1:-1)),c())}),e.addEventListener(`mouseenter`,l),e.addEventListener(`mouseleave`,c),s(0),c()}function Z(){return`
    ...
    <section id="er-faculty" class="er-section" style="background: linear-gradient(180deg, #f0faf4 0%, #ffffff 100%); padding: 4.236rem 0;">
        ...
        <div class="er-faculty-card glass-card er-reveal visible">
            <div class="er-faculty-img-wrap">
                <img src="${e.image}" class="er-faculty-img" alt="${e.name}" style="width: 100%; height: 100%; object-fit: contain; object-position: bottom center; ${e.imgStyle||``}">
    ...
    `,e.appendChild(t),document.body.appendChild(e),setTimeout(()=>{e.classList.add(`visible`),t.classList.add(`visible`)},50);let n=()=>{e.classList.remove(`visible`),t.classList.remove(`visible`),setTimeout(()=>{e.parentNode&&e.parentNode.removeChild(e)},400)};document.getElementById(`ios-popup-btn-cancel`).addEventListener(`click`,n),document.getElementById(`ios-popup-btn-x`).addEventListener(`click`,n),e.addEventListener(`click`,t=>{t.target===e&&n()}),document.getElementById(`ios-popup-btn-continue`).addEventListener(`click`,()=>{navigator.clipboard.writeText(`rwoaln`).catch(e=>console.log(`Clipboard error:`,e)),window.open(`https://apps.apple.com/in/app/myinstitute/id1472483563`,`_blank`),n()})}function Q(e,t,n){document.title=e;let r=document.querySelector(`meta[name="description"]`);if(r||(r=document.createElement(`meta`),r.name=`description`,document.head.appendChild(r)),r.content=t,n){let e=document.querySelector(`link[rel="canonical"]`);e||(e=document.createElement(`link`),e.rel=`canonical`,document.head.appendChild(e)),e.href=n}}var pe={"/":{render:()=>Y()+Z()+re()+ie()+oe()+ce()+ue(),postRender:()=>{X(),ae(),se(),le(),$(),Q(`Best Online Coaching for IIT-JEE, NEET & Class 6-10 | EduRain`,`EduRain offers online coaching for Class 6-10, foundation courses, IIT-JEE preparation, NEET coaching, board exams and competitive exam preparation.`,`https://www.edurain.in/`)}},"/courses":{render:()=>T(),postRender:()=>{E(),Q(`Explore Our All Courses – IIT JEE, NEET & Foundation (Class 6-10)`,`Explore IIT JEE, NEET & Foundation courses for Class 6-10 with expert faculty, structured curriculum & proven results. Take the first step toward success`,`https://www.edurain.in/courses`)}},"/blogs":{render:()=>k(),postRender:()=>{j(),Q(`IIT JEE, NEET & Foundation Blogs | EduRain`,`Read blogs on IIT JEE preparation, NEET exam strategy, and Foundation (6th-10th) study guides`,`https://www.edurain.in/blogs`)}},"/journey":{render:()=>B(),postRender:()=>V()},"/about-us":{render:()=>M(),postRender:()=>Q(`About Us - EduRain`,`About EduRain`,`https://www.edurain.in/about-us`)},"/reviews":{render:()=>P(),postRender:()=>F()},"/contact-us":{render:()=>I(),postRender:()=>L()},"/privacy":{render:()=>H(),postRender:()=>{}},"/terms":{render:()=>U(),postRender:()=>Q(`Terms and Conditions - EduRain`,`Terms and conditions of use for Edurain`)},"/sitemap":{render:()=>W(),postRender:()=>Q(`Sitemap - EduRain`,`Sitemap for EduRain`)},"/courses/iit-jee":{render:()=>K(),postRender:()=>Q(`Best IIT JEE Online Coaching for JEE Main & Advanced | EduRain`,`Crack IIT JEE with EduRain: live classes, expert faculty, and structured material for complete JEE Main & Advanced exam preparation`,`https://www.edurain.in/courses/iit-jee`)},"/courses/neet":{render:()=>q(),postRender:()=>Q(`NEET 2027-28 Complete Online Preparation with EduRain`,`Start your NEET 2027-28 online preparation with EduRain: live classes, expert faculty, and structured NCERT-based material with regular tests.`,`https://www.edurain.in/courses/neet`)},"/courses/foundation":{render:()=>J(),postRender:()=>Q(`Best Online Coaching for Classes 6 to 10 | Live Interactive Classes`,`Live online classes for Class 6 to 10 with expert-led Math, Science & more: building a strong IIT JEE & NEET foundation. Interactive learning, real results`,`https://www.edurain.in/courses/foundation`)}};function $(){let e=document.querySelectorAll(`.er-reveal`);if(!e.length)return;let t=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&(e.target.classList.add(`visible`),t.unobserve(e.target))})},{threshold:.12});e.forEach(e=>t.observe(e))}var me=e=>{window.history.pushState({},``,e),window.renderRoute&&window.renderRoute()},he=()=>{let e=document.getElementById(`app`),t=new URLSearchParams(window.location.search).get(`p`);t&&window.history.replaceState(null,null,t),document.body.addEventListener(`click`,e=>{if(e.defaultPrevented)return;let t=e.target.closest(`a`);if(t&&t.href){if(t.getAttribute(`href`)===`#`)return;try{let n=new URL(t.href);if(n.origin===window.location.origin){if(t.target===`_blank`||n.pathname.startsWith(`/jeecourse`)||n.pathname.startsWith(`/neetcourse`)||n.pathname.startsWith(`/foundationcourse`))return;e.preventDefault(),me(n.pathname)}}catch{}}}),window.renderRoute=()=>{let t=window.location.pathname;t===``||t===`/`?t=`/`:t.endsWith(`/`)&&(t=t.slice(0,-1));let n=pe[t]||{render:()=>`<div class="page-404"><h1>404</h1><p>Page not found</p><a href="/" class="btn btn-accent">Go Home</a></div>`,postRender:()=>{}},r=te(),i=n.render(),a=S(),o=R();e.innerHTML=`
      ${r}
