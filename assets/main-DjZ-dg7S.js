import{_ as e,a as t,b as n,c as r,d as i,f as a,g as o,h as s,i as c,l,m as u,n as d,o as f,p,r as m,s as h,t as ee,u as g,v as _,y as v}from"./vendor-Boxe3_tG.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var y=n({apiKey:`AIzaSyBLw5eneJGCi4-YshAf5wgBA-yDT8o70Mc`,authDomain:`edurain-pvt.firebaseapp.com`,projectId:`edurain-pvt`,storageBucket:`edurain-pvt.firebasestorage.app`,messagingSenderId:`5660601224`,appId:`1:5660601224:web:e12194bc33e38cd1e8e83d`,measurementId:`G-JL0D0KVQYZ`}),b=s(y),x=a(y);d(y);var S=async(e,t,n)=>{try{await r(i(x,`users`,e),{name:t,email:n,created_at:p()})}catch(e){throw Error(`Could not save user data: `+e.message)}},C=async(e,t,n)=>{try{await m(g(x,`contacts`),{name:e,email:t,message:n,created_at:p()})}catch(e){throw Error(`Could not send message: `+e.message)}},w=async(e,t,n)=>{try{let r=(await u(b,t,n)).user;return await v(r,{displayName:e}),await S(r.uid,e,t),r}catch(e){throw Error(e.message||`Registration failed`)}},T=async(t,n)=>{try{return(await e(b,t,n)).user}catch(e){throw Error(e.message||`Login failed`)}},E=async()=>{try{await _(b)}catch(e){throw Error(e.message||`Logout failed`)}},D=e=>o(b,e);function O(){return`
    ...
    `}).join(``)}
        ...
        ${JSON.stringify({"@context":`https://schema.org`,"@type":`FAQPage`,mainEntity:t.map(e=>({"@type":`Question`,name:e.question,acceptedAnswer:{"@type":`Answer`,text:e.answer}}))})}
        <\/script>
