const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/courses-BUfp9lGm.js","assets/courses-BKPhEzz0.js","assets/faq-Bo7AT8JC.js","assets/blogs-CvbTr0tV.js","assets/vendor-KXUyWc_1.js","assets/rolldown-runtime-QTnfLwEv.js","assets/vendor-DVB7LGv8.css","assets/categoryCourses-Ddtl866C.js","assets/blogAdmin-CV2mDSOc.js","assets/blogAdminLogin-DbWP5lcE.js"])))=>i.map(i=>d[i]);
import"./modulepreload-polyfill-Dezn_h7o.js";import{$ as e,B as t,H as n,Q as r,V as i,X as a,Y as o,Z as s,at as c,et as l,it as u,nt as d,q as f,rt as p,tt as m}from"./vendor-KXUyWc_1.js";var h=c({apiKey:`AIzaSyBLw5eneJGCi4-YshAf5wgBA-yDT8o70Mc`,authDomain:`edurain-pvt.firebaseapp.com`,projectId:`edurain-pvt`,storageBucket:`edurain-pvt.firebasestorage.app`,messagingSenderId:`5660601224`,appId:`1:5660601224:web:e12194bc33e38cd1e8e83d`,measurementId:`G-JL0D0KVQYZ`}),g=l(h),_=s(h);i(h);var v=async(e,t,n)=>{try{await f(a(_,`users`,e),{name:t,email:n,created_at:r()})}catch(e){throw Error(`Could not save user data: `+e.message)}},y=async(e,t,i)=>{try{await n(o(_,`contacts`),{name:e,email:t,message:i,created_at:r()})}catch(e){throw Error(`Could not send message: `+e.message)}},b=async(t,n,r)=>{try{let i=(await e(g,n,r)).user;return await u(i,{displayName:t}),await v(i.uid,t,n),i}catch(e){throw Error(e.message||`Registration failed`)}},x=async(e,t)=>{try{return(await d(g,e,t)).user}catch(e){throw Error(e.message||`Login failed`)}},S=async()=>{try{await p(g)}catch(e){throw Error(e.message||`Logout failed`)}},C=e=>m(g,e);function w(){return`
    ...
    `,e.appendChild(t),document.body.appendChild(e),setTimeout(()=>{e.classList.add(`visible`),t.classList.add(`visible`)},50);let n=()=>{e.classList.remove(`visible`),t.classList.remove(`visible`),setTimeout(()=>{e.parentNode&&e.parentNode.removeChild(e)},400)};document.getElementById(`ios-popup-btn-cancel`).addEventListener(`click`,n),document.getElementById(`ios-popup-btn-x`).addEventListener(`click`,n),e.addEventListener(`click`,t=>{t.target===e&&n()}),document.getElementById(`ios-popup-btn-continue`).addEventListener(`click`,()=>{navigator.clipboard.writeText(`rwoaln`).catch(e=>console.log(`Clipboard error:`,e)),window.open(`https://apps.apple.com/in/app/myinstitute/id1472483563`,`_blank`),n()})}function M(e,t,n){document.title=e;let r=document.querySelector(`meta[name="description"]`);if(r||(r=document.createElement(`meta`),r.name=`description`,document.head.appendChild(r)),r.content=t,n){let e=document.querySelector(`link[rel="canonical"]`);e||(e=document.createElement(`link`),e.rel=`canonical`,document.head.appendChild(e)),e.href=n}}var N={},P={"/":{load:async()=>{let[{renderBanner:e,initBanner:n},{renderPopularCourses:r},{renderFreeDemo:i},{renderFaculty:a,initFaculty:o},{renderHomeReviews:s,initHomeReviews:c},{renderImpact:l,initImpact:u},{renderAppDownload:d}]=await Promise.all([t(()=>import(`./banner-C-YUuRnB.js`),[]),t(()=>import(`./popularCourses-D1oW3aV3.js`),[]),t(()=>import(`./freeDemo-Cmbp0avJ.js`),[]),t(()=>import(`./faculty-D-Yzd8rE.js`),[]),t(()=>import(`./homeReviews-DZJizj6C.js`),[]),t(()=>import(`./impact-BAudM9QS.js`),[]),t(()=>import(`./appDownload-N3TINJ8Z.js`),[])]);return{render:()=>e()+r()+i()+a()+s()+l()+d(),postRender:()=>{n(),o(),c(),u(),F(),M(`Best Online Coaching for IIT-JEE, NEET & Class 6-10 | EduRain`,`EduRain is an online education platform providing academic learning and exam preparation for Class 6–12, Foundation, NEET and IIT-JEE.`,`https://www.edurain.in/`)}}}},"/courses":{load:async()=>{let{renderCourses:e,initCourses:n}=await t(async()=>{let{renderCourses:e,initCourses:t}=await import(`./courses-BUfp9lGm.js`);return{renderCourses:e,initCourses:t}},__vite__mapDeps([0,1,2]));return{render:()=>e(),postRender:()=>{n(),M(`Explore Our All Courses – IIT JEE, NEET & Foundation (Class 6-10)`,`Explore IIT JEE, NEET & Foundation courses for Class 6-10 with expert faculty, structured curriculum & proven results. Take the first step toward success`,`https://www.edurain.in/courses`)}}}},"/blogs":{load:async()=>{let{renderBlogs:e,initBlogs:n}=await t(async()=>{let{renderBlogs:e,initBlogs:t}=await import(`./blogs-CvbTr0tV.js`);return{renderBlogs:e,initBlogs:t}},__vite__mapDeps([3,4,5,6,1]));return{render:()=>e(),postRender:()=>{n(),M(`IIT JEE, NEET & Foundation Blogs | EduRain`,`Read blogs on IIT JEE preparation, NEET exam strategy, and Foundation (6th-10th) study guides`,`https://www.edurain.in/blogs`)}}}},"/journey":{load:async()=>{let{renderJourney:e,initJourney:n}=await t(async()=>{let{renderJourney:e,initJourney:t}=await import(`./journey-CRZRBlkv.js`);return{renderJourney:e,initJourney:t}},[]);return{render:()=>e(),postRender:()=>n()}}},"/about-us":{load:async()=>{let{renderAbout:e}=await t(async()=>{let{renderAbout:e}=await import(`./about-By50-aw2.js`);return{renderAbout:e}},[]);return{render:()=>e(),postRender:()=>M(`About Us | EduRain's Mission to Make Learning Accessible`,`At EduRain, our mission is to make quality education accessible for every student from Class 6-10 foundation to IIT-JEE & NEET success. Know our story`,`https://www.edurain.in/about-us`)}}},"/reviews":{load:async()=>{let{renderReviews:e,initReviews:n}=await t(async()=>{let{renderReviews:e,initReviews:t}=await import(`./reviews-Blh4o411.js`);return{renderReviews:e,initReviews:t}},[]);return{render:()=>e(),postRender:()=>n()}}},"/contact-us":{load:async()=>{let{renderContact:e,initContact:n}=await t(async()=>{let{renderContact:e,initContact:t}=await import(`./contact-DOqQ4aCM.js`);return{renderContact:e,initContact:t}},[]);return{render:()=>e(),postRender:()=>{n(),M(`Contact Us | Get in Touch with EduRain`,`Have questions about our courses for Class 6-10, IIT-JEE or NEET? Contact EduRain's team for admissions support, course details or a free demo class`,`https://www.edurain.in/contact-us`)}}}},"/privacy":{load:async()=>{let{renderPrivacy:e}=await t(async()=>{let{renderPrivacy:e}=await import(`./privacy-B7H0r27C.js`);return{renderPrivacy:e}},[]);return{render:()=>e(),postRender:()=>M(`Privacy Policy - EduRain`,`Privacy policy of EduRain`,`https://www.edurain.in/privacy`)}}},"/terms":{load:async()=>{let{renderTerms:e}=await t(async()=>{let{renderTerms:e}=await import(`./terms-CSkLg5fH.js`);return{renderTerms:e}},[]);return{render:()=>e(),postRender:()=>M(`Terms and Conditions - EduRain`,`Terms and conditions of use for Edurain`)}}},"/sitemap":{load:async()=>{let{renderSitemap:e}=await t(async()=>{let{renderSitemap:e}=await import(`./sitemap-9E5uki61.js`);return{renderSitemap:e}},[]);return{render:()=>e(),postRender:()=>M(`Sitemap - EduRain`,`Sitemap for EduRain`)}}},"/courses/iit-jee":{load:async()=>{let[{renderJEECourses:e},{initFAQ:n}]=await Promise.all([t(()=>import(`./categoryCourses-Ddtl866C.js`),__vite__mapDeps([7,1,2])),t(()=>import(`./faq-Bo7AT8JC.js`),[])]);return{render:()=>e(),postRender:()=>{n(),M(`Best IIT JEE Online Coaching for JEE Main & Advanced | EduRain`,`Crack IIT JEE with EduRain: live classes, expert faculty, and structured material for complete JEE Main & Advanced exam preparation`,`https://www.edurain.in/courses/iit-jee`),window.anime&&window.anime({targets:`.er-anime-reveal`,translateY:[40,0],opacity:[0,1],easing:`easeOutExpo`,duration:1200,delay:window.anime.stagger(150,{start:300})})}}}},"/courses/neet":{load:async()=>{let[{renderNEETCourses:e},{initFAQ:n}]=await Promise.all([t(()=>import(`./categoryCourses-Ddtl866C.js`),__vite__mapDeps([7,1,2])),t(()=>import(`./faq-Bo7AT8JC.js`),[])]);return{render:()=>e(),postRender:()=>{n(),M(`NEET 2027-28 Complete Online Preparation with EduRain`,`Start your NEET 2027-28 online preparation with EduRain: live classes, expert faculty, and structured NCERT-based material with regular tests.`,`https://www.edurain.in/courses/neet`),window.anime&&window.anime({targets:`.er-anime-reveal`,translateY:[40,0],opacity:[0,1],easing:`easeOutExpo`,duration:1200,delay:window.anime.stagger(150,{start:300})})}}}},"/courses/foundation":{load:async()=>{let[{renderFoundationCourses:e},{initFAQ:n}]=await Promise.all([t(()=>import(`./categoryCourses-Ddtl866C.js`),__vite__mapDeps([7,1,2])),t(()=>import(`./faq-Bo7AT8JC.js`),[])]);return{render:()=>e(),postRender:()=>{n(),M(`Best Online Coaching for Classes 6 to 10 | Live Interactive Classes`,`Live online classes for Class 6 to 10 with expert-led Math, Science & more: building a strong IIT JEE & NEET foundation. Interactive learning, real results`,`https://www.edurain.in/courses/foundation`),window.anime&&window.anime({targets:`.er-anime-reveal`,translateY:[40,0],opacity:[0,1],easing:`easeOutExpo`,duration:1200,delay:window.anime.stagger(150,{start:300})})}}}},"/blogadmin":{load:async()=>{let{renderBlogAdmin:e,initBlogAdmin:n}=await t(async()=>{let{renderBlogAdmin:e,initBlogAdmin:t}=await import(`./blogAdmin-CV2mDSOc.js`);return{renderBlogAdmin:e,initBlogAdmin:t}},__vite__mapDeps([8,4,5,6,1]));return{render:()=>e(),postRender:()=>n()}}},"/blogadmin/login":{load:async()=>{let{renderBlogAdminLogin:e,initBlogAdminLogin:n}=await t(async()=>{let{renderBlogAdminLogin:e,initBlogAdminLogin:t}=await import(`./blogAdminLogin-DbWP5lcE.js`);return{renderBlogAdminLogin:e,initBlogAdminLogin:t}},__vite__mapDeps([9,4,5,6]));return{render:()=>e(),postRender:()=>n()}}}};function F(){let e=document.querySelectorAll(`.er-reveal`);if(!e.length)return;let t=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&(e.target.classList.add(`visible`),t.unobserve(e.target))})},{threshold:.12});e.forEach(e=>t.observe(e))}window.prefetchRoute=e=>{P[e]&&!N[e]&&P[e].load()};var I=e=>{window.history.pushState({},``,e),window.renderRoute&&window.renderRoute()},L=()=>{let e=document.getElementById(`app`),t=new URLSearchParams(window.location.search).get(`p`);t&&window.history.replaceState(null,null,t),document.body.addEventListener(`mouseover`,e=>{let t=e.target.closest(`a`);if(t&&t.href)try{let e=new URL(t.href);if(e.origin===window.location.origin){let t=e.pathname;t.endsWith(`/`)&&t!==`/`&&(t=t.slice(0,-1)),window.prefetchRoute(t)}}catch{}}),document.body.addEventListener(`click`,e=>{if(e.defaultPrevented)return;let t=e.target.closest(`a`);if(t&&t.href){if(t.getAttribute(`href`)===`#`)return;try{let n=new URL(t.href);if(n.origin===window.location.origin){if(t.target===`_blank`||n.pathname.startsWith(`/jeecourse`)||n.pathname.startsWith(`/neetcourse`)||n.pathname.startsWith(`/foundationcourse`))return;e.preventDefault(),I(n.pathname)}}catch{}}}),window.renderRoute=async()=>{let t=window.location.pathname,n=t;t===``||t===`/`?t=`/`:t.endsWith(`/`)&&(t=t.slice(0,-1)),n!==t&&t!==`/`&&window.history.replaceState(window.history.state,``,t+window.location.search+window.location.hash);let r=P[t];!r&&t.startsWith(`/blogs/`)&&(r=P[`/blogs`]);let i;r?(N[t]||(N[t]=await r.load()),i=N[t]):i={render:()=>`<div class="page-404"><h1>404</h1><p>Page not found</p><a href="/" class="btn btn-accent">Go Home</a></div>`,postRender:()=>{}};let a=t.startsWith(`/blogadmin`)||t.startsWith(`/study`),o=a?``:w(),s=a?``:E();t.startsWith(`/blogadmin`);let c=i.render();e.innerHTML=`
      ${o}
