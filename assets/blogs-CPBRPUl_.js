import{_t as e,ft as t,mt as n,pt as r}from"./vendor-Gspi1HU6.js";import{r as i}from"./main-H8Gat0nG.js";import{t as a}from"./courses-BKPhEzz0.js";var o=[`All Blogs`,`Study Hacks`,`JEE Mains PYQ`,`NEET Test Series`,`CBSE Class 10 PYQ`,`CBSE Class 12 PYQ`,`Foundation 9th-10th`],s=[];function c(){return`
    ...
    `}async function u(){let o=document.getElementById(`er-blog-search-input`),c=document.getElementById(`er-tags-container`),u=document.getElementById(`er-blogs-grid-container`),d=document.getElementById(`blog-list-view`),f=document.getElementById(`blog-reader-view`),p=document.getElementById(`pw-reader-main-content`),m=document.getElementById(`pw-reader-related-container`);if(!u||!f)return;let h=`All Blogs`,g=``;try{s=(await t(n(e(i,`blogs`),r(`date`,`desc`)))).docs.map(e=>({id:e.id,...e.data()})).filter(e=>e.status===`published`);let a=[...new Set(s.map(e=>e.category).filter(e=>e))];c&&(c.innerHTML=`
            ...
            `).join(``)}let h=document.getElementById(`pw-sidebar-banner-container`);if(h)if(n.sidebarBannerImage){let e=n.sidebarBannerLink||`#`,t=e.includes(`youtube.com`)||e.includes(`youtu.be`)?`
                ...
                `,h.style.display=`block`}else h.style.display=`none`,h.innerHTML=``;p.innerHTML=`
        ...
        `;let g=s.filter(e=>e.id!==n.id).slice(0,3);m.innerHTML=`
