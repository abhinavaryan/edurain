import{_ as e,a as t,b as n,c as r,d as i,f as a,g as o,h as s,i as c,l,m as u,n as d,o as f,p,r as m,s as h,t as g,u as _,v,y}from"./vendor-Boxe3_tG.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var b=n({apiKey:`AIzaSyBLw5eneJGCi4-YshAf5wgBA-yDT8o70Mc`,authDomain:`edurain-pvt.firebaseapp.com`,projectId:`edurain-pvt`,storageBucket:`edurain-pvt.firebasestorage.app`,messagingSenderId:`5660601224`,appId:`1:5660601224:web:e12194bc33e38cd1e8e83d`,measurementId:`G-JL0D0KVQYZ`}),x=s(b),S=a(b);d(b);var C=async(e,t,n)=>{try{await r(i(S,`users`,e),{name:t,email:n,created_at:p()})}catch(e){throw Error(`Could not save user data: `+e.message)}},w=async(e,t,n)=>{try{await m(_(S,`contacts`),{name:e,email:t,message:n,created_at:p()})}catch(e){throw Error(`Could not send message: `+e.message)}},T=async(e,t,n)=>{try{let r=(await u(x,t,n)).user;return await y(r,{displayName:e}),await C(r.uid,e,t),r}catch(e){throw Error(e.message||`Registration failed`)}},E=async(t,n)=>{try{return(await e(x,t,n)).user}catch(e){throw Error(e.message||`Login failed`)}},ee=async()=>{try{await v(x)}catch(e){throw Error(e.message||`Logout failed`)}},te=e=>o(x,e);function ne(){return`
    ...
    `}function k(){document.querySelectorAll(`.social-dropdown-toggle`).forEach(e=>{let t=e.closest(`.social-dropdown-wrapper`);t&&e.addEventListener(`click`,e=>{e.stopPropagation(),document.querySelectorAll(`.social-dropdown-wrapper.active`).forEach(e=>{e!==t&&e.classList.remove(`active`)}),t.classList.toggle(`active`)})}),document.addEventListener(`click`,e=>{document.querySelectorAll(`.social-dropdown-wrapper.active`).forEach(t=>{t.contains(e.target)||t.classList.remove(`active`)})})}var A=[{id:`c1`,title:`Dropper JEE 2027 Batch`,instructor:`Ms.Ritu , Mr.Diwakar ,Mr.Banarjee`,rating:4.2,students:500,price:`₹12,520`,thumbnail:`https://cdn.phototourl.com/free/2026-08-14-50ced64b-6d99-422d-91fb-8a62bfa1e137.webp`,category:`JEE`,description:`Master the fundamentals of Calculus and Linear Algebra. Perfect for engineering aspirants.`,link:`https://courses.edurain.in/courses/849750`},{id:`c2`,title:`CLASS 11TH MATHEMATICS`,instructor:`Mr.Banarjee Sir`,rating:4.5,students:302,price:`₹2,520`,thumbnail:`https://cdn.phototourl.com/free/2026-08-14-105e8fdd-49f2-4184-9f47-9c66ccfe1665.webp`,category:`JEE`,description:`Master the fundamentals of Calculus and Linear Algebra. Perfect for engineering aspirants.`,link:`https://courses.edurain.in/courses/857872`},{id:`c6`,title:`CLASS 12TH MATHEMATICS`,instructor:`Mr.Banarjee Sir`,rating:4.8,students:132,price:`₹2,520`,thumbnail:`https://xrmvmgtcgjjhljcmnhsn.supabase.co/storage/v1/object/public/images/1786707733989_84534946_unnamed.webp`,category:`JEE`,description:`Crack product-based company interviews with robust DSA concepts.`,link:`https://courses.edurain.in/courses/857872`},{id:`c7`,title:`CLASS 11TH PCB(NEET)`,instructor:`Ms.Ritu , Mr.Diwakar ,Mr.Nitin`,rating:4.5,students:620,price:`₹5,020`,thumbnail:`https://xrmvmgtcgjjhljcmnhsn.supabase.co/storage/v1/object/public/images/1786707980934_915096e8_unnamed.webp`,category:`NEET`,description:`Clear your basics in Organic Chemistry with reaction mechanisms and practical examples.`,link:`https://courses.edurain.in/courses/855893`},{id:`c8`,title:`DROPPER NEET 2027 BATCH`,instructor:`Ms.Ritu , Mr.Diwakar ,Mr.Nitin`,rating:4.7,students:1800,price:`₹12,520`,thumbnail:`https://xrmvmgtcgjjhljcmnhsn.supabase.co/storage/v1/object/public/images/1786708172893_14fde1b1_unnamed.webp`,category:`NEET`,description:`Boost your calculation speed using ancient Vedic Math techniques.`,link:`https://courses.edurain.in/courses/849750`},{id:`c9`,title:`CLASS 11TH PCB(JEE)`,instructor:`Ms.Ritu , Mr.Diwakar ,Mr.Banarjee`,rating:4.9,students:1200,price:`₹5,020`,thumbnail:`https://xrmvmgtcgjjhljcmnhsn.supabase.co/storage/v1/object/public/images/1786708237356_3e4e42b7_unnamed.webp`,category:`JEE`,description:`A complete beginner's guide to understanding, reading, and speaking Hindi.`,link:`https://courses.edurain.in/courses/846771`},{id:`c10`,title:`CLASS 8TH`,instructor:`Manoj Sir,Khushbu ma'am ,Nandini ma'am,Sujeet sir`,rating:4.8,students:1120,price:`₹4,520`,thumbnail:`https://xrmvmgtcgjjhljcmnhsn.supabase.co/storage/v1/object/public/images/1786708300269_af0cced2_unnamed.webp`,category:`FOUNDATION`,description:`Step into the world of AI with practical Machine Learning algorithms and tools.`,link:`https://courses.edurain.in/courses/830945`},{id:`c11`,title:`CLASS 7TH`,instructor:`Manoj Sir,Khushbu ma'am ,Nandini ma'am,Sujeet sir`,rating:4.9,students:320,price:`₹3,520`,thumbnail:`https://xrmvmgtcgjjhljcmnhsn.supabase.co/storage/v1/object/public/images/1786708358028_b62b8226_unnamed.webp`,category:`NEET`,description:`Comprehensive biology course designed specifically for medical aspirants targeting NEET.`,link:`https://courses.edurain.in/courses/830943`},{id:`c12`,title:`CLASS 12TH English`,instructor:`Mr.Manoj Sir`,rating:4.1,students:126,price:`₹2,520`,thumbnail:`https://xrmvmgtcgjjhljcmnhsn.supabase.co/storage/v1/object/public/images/1786708411693_43d53417_unnamed.webp`,category:`ALL`,description:`Comprehensive biology course designed specifically for medical aspirants targeting NEET.`,link:`https://courses.edurain.in/courses/830941`},{id:`c13`,title:`CLASS 6TH`,instructor:`Manoj Sir,Khushbu ma'am ,Nandini ma'am,Sujeet sir`,rating:4.6,students:234,price:`₹3,520`,thumbnail:`https://xrmvmgtcgjjhljcmnhsn.supabase.co/storage/v1/object/public/images/1786708440388_cfb42854_unnamed.webp`,category:`FOUNDATION`,description:`Comprehensive biology course designed specifically for medical aspirants targeting NEET.`,link:`https://courses.edurain.in/courses/830607`},{id:`c14`,title:`CLASS 11TH ENGLISH`,instructor:`Mr.Manoj Sir`,rating:4.3,students:105,price:`₹2,520`,thumbnail:`https://xrmvmgtcgjjhljcmnhsn.supabase.co/storage/v1/object/public/images/1786708511517_f37d966c_unnamed.webp`,category:`ENGLISH`,description:`Comprehensive biology course designed specifically for medical aspirants targeting NEET.`,link:`https://courses.edurain.in/courses/828615`},{id:`c15`,title:`CLASS 9TH SUPER CAMPIONS`,instructor:`Manoj Sir,Khushbu ma'am ,Nandini ma'am,Sujeet sir`,rating:4.4,students:370,price:`₹4,520`,thumbnail:`https://xrmvmgtcgjjhljcmnhsn.supabase.co/storage/v1/object/public/images/1786708557261_08ee3912_unnamed.webp`,category:`FOUNDATION`,description:`Comprehensive biology course designed specifically for medical aspirants targeting NEET.`,link:`https://courses.edurain.in/courses/814577`},{id:`c16`,title:`CLASS 10TH DISHA BATCH`,instructor:`Manoj Sir,Khushbu ma'am ,Nandini ma'am,Sujeet sir`,rating:4.7,students:249,price:`₹4,020`,thumbnail:`https://xrmvmgtcgjjhljcmnhsn.supabase.co/storage/v1/object/public/images/1786708593166_35c415e1_unnamed.webp`,category:`FOUNDATION`,description:`Comprehensive biology course designed specifically for medical aspirants targeting NEET.`,link:`https://courses.edurain.in/courses/814204`},{id:`c17`,title:`TARGET JEE 2027 -12TH CLASS BATCH`,instructor:`Ms.Ritu , Mr.Diwakar ,Mr.Banarjee`,rating:4.45,students:425,price:`₹4,820`,thumbnail:`https://xrmvmgtcgjjhljcmnhsn.supabase.co/storage/v1/object/public/images/1786708692702_1d2899f4_unnamed.webp`,category:`JEE`,description:`Comprehensive biology course designed specifically for medical aspirants targeting NEET.`,link:`https://courses.edurain.in/courses/814178`},{id:`c18`,title:`NEET WHITE COAT 2027 -CLASS 12th`,instructor:`Ms.Ritu , Mr.Diwakar ,Mr.Nitin`,rating:4.9,students:770,price:`₹4,820`,thumbnail:`https://xrmvmgtcgjjhljcmnhsn.supabase.co/storage/v1/object/public/images/1786708771621_b592371a_unnamed.webp`,category:`NEET`,description:`Comprehensive biology course designed specifically for medical aspirants targeting NEET.`,link:`https://courses.edurain.in/courses/814170`},{id:`c19`,title:`MISSION NEET 3.0 BATCH 2028`,instructor:`Ms.Ritu , Mr.Diwakar ,Mr.Nitin`,rating:4.1,students:505,price:`₹9,019`,thumbnail:`https://xrmvmgtcgjjhljcmnhsn.supabase.co/storage/v1/object/public/images/1786708845701_d57d2524_unnamed.webp`,category:`NEET`,description:`Comprehensive biology course designed specifically for medical aspirants targeting NEET.`,link:`https://courses.edurain.in/courses/814073`},{id:`c23`,title:`JEE Mantra 3.0 Batch 2028`,instructor:`Ms.Ritu , Mr.Diwakar ,Mr.Banarjee`,rating:4.89,students:890,price:`₹9,019`,thumbnail:`https://xrmvmgtcgjjhljcmnhsn.supabase.co/storage/v1/object/public/images/1786709213605_9dd96992_unnamed.webp`,category:`JEE`,description:`Comprehensive biology course designed specifically for medical aspirants targeting NEET.`,link:`https://courses.edurain.in/courses/813811`}];function j(){return`
        <section class="courses-section" id="courses-page">
            ...
            <div class="courses-grid" id="courses-grid">
                ${A.map(e=>{let t=`⭐`.repeat(Math.round(e.rating)),n=e.students>=1e3?`${(e.students/1e3).toFixed(1)}K`:e.students;return`
    ...
    `}function M(){let e=document.querySelectorAll(`.course-card`);e.forEach(e=>{e.classList.add(`fade-in-section`,`visible`)}),e.forEach(e=>{e.style.cursor=`pointer`,e.addEventListener(`click`,t=>{if(t.target.closest(`a`))return;let n=e.getAttribute(`data-link`);n&&n!==`#`&&window.open(n,`_blank`,`noopener,noreferrer`)})})}var N=[`All Blogs`,`Study Hacks`,`JEE Mains PYQ`,`NEET Test Series`,`CBSE Class 10 PYQ`,`CBSE Class 12 PYQ`,`Foundation 9th-10th`],P=[];function F(){return`
    ...
    `}async function L(){let e=document.getElementById(`er-blog-search-input`),n=document.getElementById(`er-tags-container`),r=document.getElementById(`er-blogs-grid-container`),i=document.getElementById(`blog-list-view`),a=document.getElementById(`blog-reader-view`),o=document.getElementById(`pw-reader-main-content`),s=document.getElementById(`pw-reader-related-container`);if(!r||!a)return;let c=`All Blogs`,l=``;try{P=(await t(h(_(S,`blogs`),f(`date`,`desc`)))).docs.map(e=>({id:e.id,...e.data()})).filter(e=>e.status===`published`),u();let e=window.location.hash.split(`?`)[0].split(`/`);if(e.length>1&&e[0]===`#blogs`){let t=e[1];d(t,!1)}}catch(e){console.error(`Error fetching blogs:`,e),r.innerHTML=`<div style="text-align: center; padding: 2rem; color: #ef4444;">Failed to load blogs. Please try again later.</div>`}function u(){let e=P.filter(e=>{let t=Array.isArray(e.tags)?e.tags.map(e=>e.toLowerCase()):(e.tag||``).toLowerCase().split(`,`).map(e=>e.trim()),n=c===`All Blogs`||e.category&&e.category.toLowerCase().includes(c.toLowerCase())||t.includes(c.toLowerCase())||e.title&&e.title.toLowerCase().includes(c.toLowerCase()),r=!l||e.title&&e.title.toLowerCase().includes(l.toLowerCase())||e.excerpt&&e.excerpt.toLowerCase().includes(l.toLowerCase())||e.category&&e.category.toLowerCase().includes(l.toLowerCase());return n&&r});r.innerHTML=I(e),m()}e&&e.addEventListener(`input`,e=>{l=e.target.value.trim(),u()}),n&&n.addEventListener(`click`,e=>{let t=e.target.closest(`.er-tag-pill`);t&&(n.querySelectorAll(`.er-tag-pill`).forEach(e=>e.classList.remove(`active`)),t.classList.add(`active`),c=t.getAttribute(`data-tag`),u())});function d(e,t=!0){let n=P.find(t=>t.id===e);if(!n)return;let r=`Recently`;n.date&&(r=(n.date.toDate?n.date.toDate():new Date(n.date)).toLocaleDateString(`en-IN`,{year:`numeric`,month:`long`,day:`numeric`}));let c=``;if(c=Array.isArray(n.content)?n.content.map(e=>e.type===`heading`?`<h3 class="pw-article-h3">${e.text}</h3>`:`<p class="pw-article-p">${e.text}</p>`).join(``):`<div class="quill-content">${n.content||`<p class="pw-article-p">${n.excerpt}</p>`}</div>`,n.seo){document.title=n.seo.metaTitle||n.title;let e=document.querySelector(`meta[name="description"]`);e&&(e.content=n.seo.metaDescription||n.excerpt)}o.innerHTML=`
        ...
        `;let l=P.filter(e=>e.id!==n.id).slice(0,3);s.innerHTML=`
            ...
            <div class="reviews-carousel">
                ...
                <div class="carousel-viewport">
                    <div class="carousel-track" id="review-track">
                        ${z.map((e,t)=>{let n=[`linear-gradient(135deg, #10b981 0%, #059669 100%)`,`linear-gradient(135deg, #3b82f6 0%, #1d4ed8 100%)`,`linear-gradient(135deg, #ec4899 0%, #be185d 100%)`,`linear-gradient(135deg, #f59e0b 0%, #d97706 100%)`,`linear-gradient(135deg, #8b5cf6 0%, #6d28d9 100%)`,`linear-gradient(135deg, #06b6d4 0%, #0891b2 100%)`];return`
    ...
    `}function q(){let e=document.getElementById(`architecture-modal`),t=document.getElementById(`modal-close-btn`),n=document.getElementById(`modal-title`),r=document.getElementById(`mermaid-diagram-container`);document.querySelectorAll(`.view-architecture-btn`).forEach(t=>{t.addEventListener(`click`,()=>{let i=t.dataset.project,a=`System Architecture`,o=``;if(i===`credit-risk`?(a=`💳 Credit Risk Assessment — Multi-Agent Architecture`,o=`
    graph TD
    ...
    `}function re(e){let t=`⭐`.repeat(Math.round(e.rating)),n=e.students>=1e3?`${(e.students/1e3).toFixed(1)}K`:e.students;return`
    ...
    `}function Z(e,t,n){let r=A.filter(e=>e.category===n),i=r.length>0?r.map(re).join(``):`<p style="text-align: center; width: 100%; color: var(--text-muted);">No courses available in this category yet.</p>`;return`
    ...
    `}function le(){let e=document.getElementById(`er-blog-admin-wrapper`),n=document.getElementById(`er-admin-auth-loading`);if(!e)return;let r,a=o(x,t=>{t&&t.email===`edurainseowork@gmail.com`?(n.style.display=`none`,e.style.display=`flex`,s(),b()):window.location.href=`/blogadmin/login`});document.getElementById(`admin-logout-btn`)?.addEventListener(`click`,async()=>{await v(x),window.location.href=`/blogadmin/login`});function s(){let e=document.getElementById(`view-all-blogs`),t=document.getElementById(`view-add-blog`),n=document.getElementById(`nav-all-blogs`),i=document.getElementById(`nav-add-blog`),a=document.getElementById(`btn-create-new`);function o(a){a===`all`?(e.style.display=`block`,t.style.display=`none`,n.style.background=`#16a34a`,n.style.color=`white`,i.style.background=`transparent`,i.style.color=`#cbd5e1`,b()):(e.style.display=`none`,t.style.display=`block`,i.style.background=`#16a34a`,i.style.color=`white`,n.style.background=`transparent`,n.style.color=`#cbd5e1`,r||u())}n.addEventListener(`click`,()=>o(`all`)),i.addEventListener(`click`,()=>{y(),o(`add`)}),a.addEventListener(`click`,()=>{y(),o(`add`)});let s=document.getElementById(`btn-migrate-blogs`);s.addEventListener(`click`,async()=>{if(confirm(`Are you sure you want to migrate JSON blogs to Firestore? This will push all blogs from blogs.json to the database.`)){s.textContent=`Migrating...`,s.disabled=!0;try{let e=_(S,`blogs`);for(let t of se){let n={},r=``;r=Array.isArray(t.content)?t.content.map(e=>e.type===`heading`?`<h3 class="pw-article-h3">${e.text}</h3>`:`<p class="pw-article-p">${e.text}</p>`).join(``):t.content||`<p class="pw-article-p">${t.excerpt||``}</p>`,await m(e,{title:t.title||`Untitled`,excerpt:t.excerpt||``,content:r,status:t.isPublished===!1?`draft`:`published`,coverImage:t.coverImage||`/images/default-blog.jpg`,category:t.category||`General`,tags:t.tag?t.tag.split(`,`).map(e=>e.trim()):[],author:t.author||`EduRain Team`,date:t.date?new Date(t.date):p(),seo:n,updatedAt:p()})}alert(`Migration Complete! Blogs are now in Firestore.`),b()}catch(e){console.error(`Migration failed:`,e),alert(`Migration failed! `+e.message)}s.textContent=`Migrate JSON Blogs`,s.disabled=!1}}),document.getElementById(`admin-blog-form`).addEventListener(`submit`,w)}function u(){r=new g(`#quill-editor`,{theme:`snow`,modules:{toolbar:{container:[[{header:[1,2,3,4,5,6,!1]}],[`bold`,`italic`,`underline`,`strike`],[{color:[]},{background:[]}],[{list:`ordered`},{list:`bullet`}],[`link`,`image`,`video`],[`clean`]],handlers:{image:d}}}})}function d(){let e=prompt(`Please enter the Direct URL of the image (ending in .jpg or .png):`);if(e){let t=r.getSelection();r.insertEmbed(t.index,`image`,e)}}function y(){document.getElementById(`admin-blog-form`).reset(),document.getElementById(`blog-id`).value=``,document.getElementById(`editor-title`).textContent=`Create New Blog`,document.getElementById(`save-status`).textContent=``,r&&(r.root.innerHTML=``)}async function b(){let e=document.getElementById(`admin-blogs-list`);try{let n=await t(h(_(S,`blogs`),f(`date`,`desc`)));if(n.empty){e.innerHTML=`<tr><td colspan="5" style="padding: 2rem; text-align: center;">No blogs found. Create one!</td></tr>`;return}let r=``;n.forEach(e=>{let t=e.data(),n=e.id,i=t.date?.toDate?t.date.toDate().toLocaleDateString():`Draft`,a=t.status===`published`?`<span style="background:#16a34a; padding: 4px 8px; border-radius: 4px; font-size: 0.8rem;">Published</span>`:`<span style="background:#94a3b8; padding: 4px 8px; border-radius: 4px; font-size: 0.8rem;">Draft</span>`;r+=`
    ...
    `}function de(){let t=document.getElementById(`er-admin-login-form`),n=document.getElementById(`er-admin-email`),r=document.getElementById(`er-admin-password`),i=document.getElementById(`er-admin-login-error`),a=document.getElementById(`er-admin-login-btn`);t&&t.addEventListener(`submit`,async t=>{t.preventDefault();let o=n.value.trim(),s=r.value;if(o!==`edurainseowork@gmail.com`){i.textContent=`Unauthorized email address.`,i.style.display=`block`;return}a.textContent=`Authenticating...`,a.disabled=!0,i.style.display=`none`;try{await e(x,o,s),window.location.href=`/blogadmin`}catch(e){console.error(`Login Error:`,e),i.textContent=`Invalid credentials or login failed.`,i.style.display=`block`,a.textContent=`Login to Dashboard`,a.disabled=!1}})}function fe(){return`
  ...
  `}function pe(){let e=document.getElementById(`er-slider-track`),t=document.querySelectorAll(`.er-dot`),n=document.querySelectorAll(`.er-slide`),r=document.getElementById(`er-arrow-prev`),i=document.getElementById(`er-arrow-next`);if(!e||!n.length)return;let a=0,o;function s(r){a=(r%n.length+n.length)%n.length,e.style.transform=`translateX(-${a*100}%)`,t.forEach((e,t)=>{e.classList.toggle(`er-dot-active`,t===a)})}function c(){l(),o=setInterval(()=>s(a+1),3500)}function l(){clearInterval(o)}t.forEach(e=>{e.addEventListener(`click`,()=>{l(),s(parseInt(e.dataset.index)),c()})}),r&&r.addEventListener(`click`,e=>{e.preventDefault(),l(),s(a-1),c()}),i&&i.addEventListener(`click`,e=>{e.preventDefault(),l(),s(a+1),c()});let u=0;e.addEventListener(`touchstart`,e=>{u=e.changedTouches[0].screenX},{passive:!0}),e.addEventListener(`touchend`,e=>{let t=u-e.changedTouches[0].screenX;Math.abs(t)>50&&(l(),s(a+(t>0?1:-1)),c())}),e.addEventListener(`mouseenter`,l),e.addEventListener(`mouseleave`,c),s(0),c()}function me(){return`
    ...
    `}function xe(){let e=document.querySelectorAll(`.er-count`),t=!1;function n(e){let t=parseInt(e.dataset.target,10),n=e.dataset.suffix||``,r=0;function i(e){return t>=1e6?(e/1e6).toFixed(0)+n:e.toLocaleString(`en-IN`)+n}e.textContent=i(0);let a=setInterval(()=>{r=Math.min(r+Math.ceil(t/80),t),e.textContent=i(r),r>=t&&(clearInterval(a),e.textContent=i(t),e.style.animation=`erCountPing 0.4s ease-out`,setTimeout(()=>{e.style.animation=``},400))},25)}let r=document.getElementById(`er-impact`);r&&(new IntersectionObserver(r=>{r.forEach(r=>{r.isIntersecting&&!t&&(t=!0,e.forEach(e=>n(e)))})},{threshold:.25}).observe(r),document.querySelectorAll(`.er-impact-card`).forEach(e=>{let t=e.querySelector(`.er-impact-bar`);e.addEventListener(`mouseenter`,()=>{t&&t.classList.add(`er-bar-expanded`),e.style.transform=`translateY(-6px)`}),e.addEventListener(`mouseleave`,()=>{t&&t.classList.remove(`er-bar-expanded`),e.style.transform=`translateY(0)`})}))}function Q(){return`
    ...
    `,e.appendChild(t),document.body.appendChild(e),setTimeout(()=>{e.classList.add(`visible`),t.classList.add(`visible`)},50);let n=()=>{e.classList.remove(`visible`),t.classList.remove(`visible`),setTimeout(()=>{e.parentNode&&e.parentNode.removeChild(e)},400)};document.getElementById(`ios-popup-btn-cancel`).addEventListener(`click`,n),document.getElementById(`ios-popup-btn-x`).addEventListener(`click`,n),e.addEventListener(`click`,t=>{t.target===e&&n()}),document.getElementById(`ios-popup-btn-continue`).addEventListener(`click`,()=>{navigator.clipboard.writeText(`rwoaln`).catch(e=>console.log(`Clipboard error:`,e)),window.open(`https://apps.apple.com/in/app/myinstitute/id1472483563`,`_blank`),n()})}function $(e,t,n){document.title=e;let r=document.querySelector(`meta[name="description"]`);if(r||(r=document.createElement(`meta`),r.name=`description`,document.head.appendChild(r)),r.content=t,n){let e=document.querySelector(`link[rel="canonical"]`);e||(e=document.createElement(`link`),e.rel=`canonical`,document.head.appendChild(e)),e.href=n}}var we={"/":{render:()=>fe()+me()+he()+ge()+ve()+be()+Q(),postRender:()=>{pe(),_e(),ye(),xe(),Te(),$(`Best Online Coaching for IIT-JEE, NEET & Class 6-10 | EduRain`,`EduRain offers online coaching for Class 6-10, foundation courses, IIT-JEE preparation, NEET coaching, board exams and competitive exam preparation.`,`https://www.edurain.in/`)}},"/courses":{render:()=>j(),postRender:()=>{M(),$(`Explore Our All Courses – IIT JEE, NEET & Foundation (Class 6-10)`,`Explore IIT JEE, NEET & Foundation courses for Class 6-10 with expert faculty, structured curriculum & proven results. Take the first step toward success`,`https://www.edurain.in/courses`)}},"/blogs":{render:()=>F(),postRender:()=>{L(),$(`IIT JEE, NEET & Foundation Blogs | EduRain`,`Read blogs on IIT JEE preparation, NEET exam strategy, and Foundation (6th-10th) study guides`,`https://www.edurain.in/blogs`)}},"/journey":{render:()=>K(),postRender:()=>q()},"/about-us":{render:()=>R(),postRender:()=>$(`About Us | EduRain's Mission to Make Learning Accessible`,`At EduRain, our mission is to make quality education accessible for every student from Class 6-10 foundation to IIT-JEE & NEET success. Know our story`,`https://www.edurain.in/about-us`)},"/reviews":{render:()=>B(),postRender:()=>V()},"/contact-us":{render:()=>H(),postRender:()=>{U(),$(`Contact Us | Get in Touch with EduRain`,`Have questions about our courses for Class 6-10, IIT-JEE or NEET? Contact EduRain's team for admissions support, course details or a free demo class`,`https://www.edurain.in/contact-us`)}},"/privacy":{render:()=>J(),postRender:()=>{}},"/terms":{render:()=>Y(),postRender:()=>$(`Terms and Conditions - EduRain`,`Terms and conditions of use for Edurain`)},"/sitemap":{render:()=>X(),postRender:()=>$(`Sitemap - EduRain`,`Sitemap for EduRain`)},"/courses/iit-jee":{render:()=>ie(),postRender:()=>$(`Best IIT JEE Online Coaching for JEE Main & Advanced | EduRain`,`Crack IIT JEE with EduRain: live classes, expert faculty, and structured material for complete JEE Main & Advanced exam preparation`,`https://www.edurain.in/courses/iit-jee`)},"/courses/neet":{render:()=>ae(),postRender:()=>$(`NEET 2027-28 Complete Online Preparation with EduRain`,`Start your NEET 2027-28 online preparation with EduRain: live classes, expert faculty, and structured NCERT-based material with regular tests.`,`https://www.edurain.in/courses/neet`)},"/courses/foundation":{render:()=>oe(),postRender:()=>$(`Best Online Coaching for Classes 6 to 10 | Live Interactive Classes`,`Live online classes for Class 6 to 10 with expert-led Math, Science & more: building a strong IIT JEE & NEET foundation. Interactive learning, real results`,`https://www.edurain.in/courses/foundation`)},"/blogadmin":{render:()=>ce(),postRender:()=>le()},"/blogadmin/login":{render:()=>ue(),postRender:()=>de()}};function Te(){let e=document.querySelectorAll(`.er-reveal`);if(!e.length)return;let t=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&(e.target.classList.add(`visible`),t.unobserve(e.target))})},{threshold:.12});e.forEach(e=>t.observe(e))}var Ee=e=>{window.history.pushState({},``,e),window.renderRoute&&window.renderRoute()},De=()=>{let e=document.getElementById(`app`),t=new URLSearchParams(window.location.search).get(`p`);t&&window.history.replaceState(null,null,t),document.body.addEventListener(`click`,e=>{if(e.defaultPrevented)return;let t=e.target.closest(`a`);if(t&&t.href){if(t.getAttribute(`href`)===`#`)return;try{let n=new URL(t.href);if(n.origin===window.location.origin){if(t.target===`_blank`||n.pathname.startsWith(`/jeecourse`)||n.pathname.startsWith(`/neetcourse`)||n.pathname.startsWith(`/foundationcourse`))return;e.preventDefault(),Ee(n.pathname)}}catch{}}}),window.renderRoute=()=>{let t=window.location.pathname;t===``||t===`/`?t=`/`:t.endsWith(`/`)&&(t=t.slice(0,-1));let n=we[t]||{render:()=>`<div class="page-404"><h1>404</h1><p>Page not found</p><a href="/" class="btn btn-accent">Go Home</a></div>`,postRender:()=>{}},r=t.startsWith(`/blogadmin`)?``:ne(),i=t.startsWith(`/blogadmin`)?``:O(),a=t.startsWith(`/blogadmin`)?``:W(),o=n.render();e.innerHTML=`
      ${r}
