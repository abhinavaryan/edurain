    ...
    const cardsHtml = faculties.map((f, i) => {
        ...
        <div class="er-faculty-card glass-card er-reveal visible">
            <div class="er-faculty-img-wrap">
                <img src="${f.image}" class="er-faculty-img" alt="${f.name} - ${f.subject} Specialist, ${f.exp}" style="width: 100%; height: 100%; object-fit: contain; object-position: bottom center; ${f.imgStyle || ''}">
